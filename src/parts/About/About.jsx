        ...
        <>
            ...
            <section className="section section--min-height-0">
                ...
                <div className="container text-cols text-cols--2cols">
                    ...
                    <p>
                        In more recent years, I've gained strong leadership
                        skills while leading a team of 4 developers, did hiring
                        and upskilling. Constantly improved the team’s skills,
                        implementing new technologies and work practices, such
                        as Sass, React, and BEM methodology, and promoted
                        constant innovation.
                    </p>
                    <p>
                        Drove the team’s visibility in the organisation by
                        working closely with other departments. Played a
                        significant role in promoting diversity and inclusion,
                        and mental health within the company.
                    </p>
                    <br />
                    <br />
                    <p>
                    ...
                    <p>
                        ...
                        As a leader, I like to focus on the growth and
                        development of my team, diversity and inclusion in the
                        workplace, promoting mental health and contribute to a
                ...
                <div className="container">
                    <Button
                        action="URL"
                        URL="https://davidlopes-download.s3.eu-west-2.amazonaws.com/CV_David_Lopes.pdf"
                    >
                        Download my CV
                    </Button>
