...
function Ca(a){var b=a.u.splice(0)[0];(b=a.l=a.l||b)?b.jc?a.i=a.s||a.o:void 0!=b.B&&a.o<b.B?(a.i=b.B,a.l=null):a.i=a.o:a.i=0}
...
var Cb={};Db("");var Eb={};function Hb(a){this.l=Eb===Eb?a:"";this.j=!0}
...
function Td(){}
;function Ud(a,b,c){return-1===b?null:b>=a.qa?a.S?a.S[b]:void 0:(void 0===c?0:c)&&a.S&&(c=a.S[b],null!=c)?c:a.v[b+a.ma]}
function D(a,b,c,d,e){d=void 0===d?!1:d;(void 0===e?0:e)||Ld(a);a.ic&&(a.ic=void 0);if(b>=a.qa||d)return(a.S||(a.S=a.v[a.qa+a.ma]={}))[b]=c,a;void 0!==a.S&&a.qa>=a.v.length?(d=a.v.length-1,e=b+a.ma,e>=d?(a.v[d]=void 0,a.v[e]=c,a.v.push(a.S)):a.v[e]=c):a.v[b+a.ma]=c;void 0!==a.S&&b in a.S&&delete a.S[b];return a}
...
function Yd(a,b,c,d){var e=d=void 0===d?!1:d,f=Ud(a,c,e);var g=!1;var h=null==f||"object"!==typeof f||(g=Array.isArray(f))||f.Db!==Ed?g?new b(f):void 0:f;h!==f&&null!=h&&(D(a,c,h,e,!0),ud(h.v,wd(a.v)&-33));b=h;if(null==b)return b;Ad(b.v)&&!Ad(a.v)&&(b=Zd(b),D(a,c,b,d));return b}
...
;function Zd(a){if(!Ad(a.v))return a;var b={rb:!0},c=Ad(a.v);if(c&&!b.rb)throw Error("copyRepeatedFields must be true for frozen messages");c||Cd(a.v);var d=new a.constructor;a.Ma&&(d.Ma=a.Ma.slice());for(var e=a.v,f=0;f<e.length;f++){var g=e[f];if(f===e.length-1&&Fd(g))for(var h in g){var k=+h;Number.isNaN(k)?(d.S||(d.S=d.v[d.qa+d.ma]={}))[h]=g[h]:ge(a,d,k,g[h],c,b)}else ge(a,d,f-a.ma,g,c,b)}d.ic=a;return d}
;function I(a,b,c){null==a&&(a=he);he=null;var d=this.constructor.i||0,e=0<d,f=this.constructor.j,g,h=!1;if(a){if(g=!!(wd(a)&16))h=wd(a),xd(a,h|32),h=!!(h&32)}else g=f?[f]:[],ud(g,48),a=g,g=!0;e&&0<a.length&&Fd(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.ma=(f?0:-1)-d;this.i=void 0;this.v=a;a:{f=this.v.length;d=f-1;if(f&&(f=this.v[d],Fd(f))){this.S=f;b=Object.keys(f);0<b.length&&jb(b,isNaN)?this.qa=Number.MAX_VALUE:this.qa=d-this.ma;break a}void 0!==b&&-1<b?(this.qa=Math.max(b,d+1-this.ma),this.S=
void 0):this.qa=Number.MAX_VALUE}if(!e&&this.S&&"g"in this.S)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(c)for(e=g&&!h?zd:yd,b=0;b<c.length;b++)g=c[b],(h=Ud(this,g))?Array.isArray(h)&&e(h):D(this,g,Kd,!1,!0)}
...
l.Db=Ed;l.toString=function(){return this.v.toString()};
...
l=ne.prototype;l.Gc=function(a){var b=Ja.apply(1,arguments),c=this.ub(b);c?c.push(new me(a)):this.vc(a,b)};
l.vc=function(a){this.Ca.set(this.cc(Ja.apply(1,arguments)),[new me(a)])};
l.ub=function(){var a=this.cc(Ja.apply(0,arguments));return this.Ca.has(a)?this.Ca.get(a):void 0};
l.Sc=function(){var a=this.ub(Ja.apply(0,arguments));return a&&a.length?a[0]:void 0};
...
u(oe,ne);oe.prototype.l=function(a){var b=Ja.apply(1,arguments),c=0,d=this.Sc(b);d&&(c=d.Ub);this.vc(c+a,b)};function pe(a,b){ne.call(this,a,2,b)}
u(pe,ne);pe.prototype.l=function(a){this.Gc(a,Ja.apply(1,arguments))};function qe(a){a&&"function"==typeof a.dispose&&a.dispose()}
...
function Ne(a,b){var c=b.type;c in a.listeners&&lb(a.listeners[c],b)&&(Ke(b),0==a.listeners[c].length&&(delete a.listeners[c],a.i--))}
...
function Ye(a,b){if(a.Oa)a=!0;else{b=new Fe(b,this);var c=a.listener,d=a.gb||a.src;a.ab&&$e(a);a=c.call(d,b)}return a}
...
return a[af]}
;function bf(){J.call(this);this.m=new Le(this);this.Dc=this;this.la=null}
...
function df(a,b,c,d){b=a.m.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.Oa&&g.capture==c){var h=g.listener,k=g.gb||g.src;g.ab&&Ne(a.m,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
function Kf(a){a.s||(a.s=!0,vf(a.Qc,a))}
function Hf(a){var b=null;a.j&&(b=a.j,a.j=b.next,b.next=null);a.j||(a.m=null);return b}
l.Qc=function(){for(var a;a=Hf(this);)If(this,a,this.i,this.C);this.s=!1};
...
l=Sf.prototype;l.tc=function(a){this.o=a;this.m=1};
...
l.Hc=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new oe(a,b))};
l.Rb=function(a){var b=Ja.apply(1,arguments);this.i.has(a)||this.i.set(a,new pe(a,b))};
function Vf(a,b){return a.s.has(b)?void 0:a.i.get(b)}
l.Lb=function(a){this.Bc.apply(this,[a,1].concat(ia(Ja.apply(1,arguments))))};
l.Bc=function(a,b){var c=Ja.apply(2,arguments),d=Vf(this,a);d&&d instanceof oe&&(d.l(b,c),Tf(this))};
...
;function Wf(a){this.i=a;this.i.Rb("/client_streamz/bg/fil",{tb:3,sb:"rk"})}
function Xf(a){this.i=a;this.i.Hc("/client_streamz/bg/fsc",{tb:3,sb:"rk"})}
function Yf(a){this.i=a;this.i.Rb("/client_streamz/bg/fsl",{tb:3,sb:"rk"})}
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,q;a();return{reset:a,update:c,digest:d,Nc:function(){for(var r=d(),w="",t=0;t<r.length;t++)w+="0123456789ABCDEF".charAt(Math.floor(r[t]/16))+"0123456789ABCDEF".charAt(r[t]%16);return w}}}
...
function mg(a){var b=jg();b.update(a);return b.Nc().toLowerCase()}
...
Gg=new Hg;function Jg(a){bf.call(this);this.headers=new Map;this.L=a||null;this.j=!1;this.K=this.A=null;this.o=this.T="";this.l=this.R=this.u=this.P=!1;this.s=0;this.H=null;this.ea="";this.X=this.Y=!1}
Za(Jg,bf);var Mg=/^https?$/i,Ng=["POST","PUT"],Og=[];function Pg(a,b,c,d,e,f,g){var h=new Jg;Og.push(h);b&&h.ja("complete",b);h.m.add("ready",h.Lc,!0,void 0,void 0);f&&(h.s=Math.max(0,f));g&&(h.Y=g);h.send(a,c,d,e)}
l=Jg.prototype;l.Lc=function(){this.dispose();lb(Og,this)};
l.send=function(a,b,c,d){if(this.A)throw Error("[goog.net.XhrIo] Object is active with another request="+this.T+"; newUri="+a);b=b?b.toUpperCase():"GET";this.T=a;this.o="";this.P=!1;this.j=!0;this.A=this.L?Ig(this.L):Ig(Gg);this.K=this.L?this.L.getOptions():Gg.getOptions();this.A.onreadystatechange=Wa(this.lc,this);try{this.getStatus(),this.R=!0,this.A.open(b,String(a),!0),this.R=!1}catch(g){this.getStatus();Qg(this,g);return}a=c||"";c=new Map(this.headers);if(d)if(Object.getPrototypeOf(d)===Object.prototype)for(var e in d)c.set(e,
...
l.D=function(){this.A&&(this.j&&(this.j=!1,this.l=!0,this.A.abort(),this.l=!1),Ug(this,!0));Jg.Z.D.call(this)};
l.lc=function(){this.i()||(this.R||this.u||this.l?Vg(this):this.bd())};
l.bd=function(){Vg(this)};
function Vg(a){if(a.j&&"undefined"!=typeof Ma)if(a.K[1]&&4==Wg(a)&&2==a.getStatus())a.getStatus();else if(a.u&&4==Wg(a))Rf(a.lc,0,a);else if(cf(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Xg(a))cf(a,"complete"),cf(a,"success");else{try{var b=2<Wg(a)?a.A.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Tg(a)}}finally{Ug(a)}}}
...
u(ih,I);var jh;jh=new function(a,b,c){this.j=a;this.fieldName=b;this.i=c;this.isRepeated=0;this.l=le}(175237375,{mr:0},ih);function kh(a,b,c,d,e,f,g,h,k,m,q){bf.call(this);var r=this;this.P="";this.l=[];this.Pb="";this.Qb=this.va=-1;this.Xa=!1;this.K=this.o=null;this.H=0;this.Ec=1;this.timeoutMillis=0;this.ea=!1;bf.call(this);this.Ob=b||function(){};
this.u=new lh(a,f);this.Cc=d;this.Wa=q;this.Fc=Ya(gf,0,1);this.T=e||null;this.L=c||null;this.X=g||!1;this.pageId=k||null;this.logger=null;this.withCredentials=!h;this.Ja=f||!1;!this.Ja&&(65<=cc("Chromium")||45<=cc("Firefox")||12<=cc("Safari")||(Fc()||C("iPad")||C("iPod"))&&Gc());a=D(new bh,1,1);mh(this.u,a);this.s=new xg(1E4);this.j=new Pf(this.s.getValue());se(this,this.j);m=nh(this,m);Re(this.j,"tick",m,!1,this);this.R=new Pf(6E5);se(this,this.R);Re(this.R,"tick",m,!1,this);this.X||this.R.start();
...
function oh(a){a.T||(a.T=.01>a.Fc()?"https://www.google.com/log?format=json&hasfast=true":"https://play.google.com/log?format=json&hasfast=true");return a.T}
...
kh.prototype.flush=function(a,b){var c=this;if(0===this.l.length)a&&a();else if(this.ea)rh(this);else{var d=Date.now();if(this.Qb>d&&this.va<d)b&&b("throttled");else{var e=sh(this.u,this.l,this.H);d={};var f=this.Ob();f&&(d.Authorization=f);var g=oh(this);this.L&&(d["X-Goog-AuthUser"]=this.L,g=wc(g,"authuser",this.L));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=wc(g,"pageId",this.pageId));if(f&&this.Pb===f)b&&b("stale-auth-token");else{this.l=[];this.j.enabled&&this.j.stop();this.H=0;var h=ie(e),
k;this.K&&this.K.isSupported(h.length)&&(k=this.K.compress(h));var m={url:g,body:h,Jc:1,Hb:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(t){c.s.reset();Qf(c.j,c.s.getValue());if(t){var y=null;try{var E=JSON.parse(t.replace(")]}'\n",""));y=new gh(E)}catch(F){}y&&(t=Number(fe(Ud(y,1),"-1")),0<t&&(c.va=Date.now(),c.Qb=c.va+t),y=jh.l(y))&&(y=fe(Ud(y,1),-1),-1!=y&&(c.Xa||ph(c,y)))}a&&a()},r=function(t,y){var E=ae(e,ch,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Qf(c.j,c.s.getValue());401===t&&f&&(c.Pb=f);void 0===y&&(y=500<=t&&600>t||401===t||0===t);y&&(c.l=E.concat(c.l),c.X||c.j.enabled||c.j.start());b&&b("net-send-failed",t)},w=function(){c.Wa?c.Wa.send(m,q,r):c.Cc(m,q,r)};
k?k.then(function(t){m.Hb["Content-Encoding"]="gzip";m.Hb["Content-Type"]="application/binary";m.body=t;m.Jc=2;w()},function(){w()}):w()}}}};
...
function th(a,b){if(0!==a.l.length){var c=Dc(oh(a),"format");c=uc(c,"auth",a.Ob(),"authuser",a.L||"0");for(var d=0;10>d&&a.l.length;++d){var e=a.l.slice(0,32),f=sh(a.u,e,a.H);if(!b(c,f))break;a.H=0;a.l=a.l.slice(e.length)}a.j.enabled&&a.j.stop()}}
...
;function wh(a,b,c){Pg(a.url,function(d){d=d.target;if(Xg(d)){try{var e=d.A?d.A.responseText:""}catch(f){e=""}b(e)}else c(d.getStatus())},a.requestType,a.body,a.Hb,a.timeoutMillis,a.withCredentials)}
...
;function Ch(a){var b=this;this.eb=!1;if(a.fd){var c;this.wa=null!=(c=a.wa)?c:new zh}c=a.program;a=a.globalName;var d=new Bh;this.j=d.promise;this.wd=p((0,z[a].a)(c,function(e,f){Promise.resolve().then(function(){var g;if(null!=(g=b.wa)){var h=Ah()-g.s;g.o.i.ob("/client_streamz/bg/fil",h,g.Fa)}d.resolve({Ic:e,td:f})})},!0)).next().value;
this.sd=d.promise.then(function(){})}
Ch.prototype.snapshot=function(a){var b=this;if(this.eb)throw Error("Already disposed");var c=Ah(),d;null!=(d=this.wa)&&d.j.i.Lb("/client_streamz/bg/fsc",d.Fa);return this.j.then(function(e){var f=e.Ic;return new Promise(function(g){f(function(h){var k;if(null!=(k=b.wa)){var m=Ah()-c;k.l.i.ob("/client_streamz/bg/fsl",m,k.Fa)}g(h)},[a.Wb,
a.ud])})})};
Ch.prototype.dispose=function(){var a;null!=(a=this.wa)&&a.i.pb();this.eb=!0;this.j.then(function(b){(b=b.td)&&b()})};
Ch.prototype.i=function(){return this.eb};var Dh=window;Db("csi.gstatic.com");Db("googleads.g.doubleclick.net");Db("partner.googleadservices.com");Db("pubads.g.doubleclick.net");Db("securepubads.g.doubleclick.net");Db("tpc.googlesyndication.com");/*
...
l.delete=function(a){return ri(this.j,a)?(delete this.j[a],--this.size,this.ra++,this.i.length>2*this.size&&qi(this),!0):!1};
...
l.set=function(a,b){ri(this.j,a)||(this.size+=1,this.i.push(a),this.ra++);this.j[a]=b};
...
l.fa=function(a){qi(this);var b=0,c=this.ra,d=this,e=new ii;e.next=function(){if(c!=d.ra)throw Error("The map has changed since the iterator was created");if(b>=d.i.length)return ji;var f=d.i[b++];return ki(a?f:d.j[f])};
return e};
...
u(Nj,I);function ik(a){I.call(this,a)}
u(ik,I);function jk(a){I.call(this,a,449)}
u(jk,I);
...
null==(r=Dh.screen)?void 0:r.availWidth;var w;e.u_cd=null==(w=Dh.screen)?void 0:w.colorDepth}catch(fa){}h=b.i;try{var t=h.screenX;var y=h.screenY}catch(fa){}try{var E=h.outerWidth;var F=h.outerHeight}catch(fa){}try{var O=h.innerWidth;var N=h.innerHeight}catch(fa){}try{var Q=h.screenLeft;var ca=h.screenTop}catch(fa){}try{O=h.innerWidth,N=h.innerHeight}catch(fa){}try{var U=h.screen.availWidth;var mb=h.screen.availTop}catch(fa){}t=[Q,ca,t,y,U,mb,E,F,O,N];try{var Xa=(b.i.top||window).document,na="CSS1Compat"==
...
function an(a){function b(){var f,g,h,k,m,q,r,w,t,y;return x(function(E){switch(E.i){case 1:return g=null!=(f=Error().stack)?f:"",ya(E,2),v(E,a.l(a.name,a.options.version,d),4);case 4:h=E.j;for(var F=a.options,O=[],N=p(Object.keys(F.Na)),Q=N.next();!Q.done;Q=N.next()){Q=Q.value;var ca=F.Na[Q],U=void 0===ca.gd?Number.MAX_VALUE:ca.gd;!(h.i.version>=ca.qb)||h.i.version>=U||h.i.objectStoreNames.contains(Q)||O.push(Q)}k=O;if(0===k.length){E.B(5);break}m=Object.keys(a.options.Na);q=h.objectStoreNames();
...
zn.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Kb?un:tn)(a,b,Object.assign({},c))};
zn.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Kb?yn:vn)(this.name,a)};
...
function Ln(a){var b=new Yi,c=new Ri;D(c,1,a.hc);D(c,2,a.fc);D(c,16,a.Uc);D(c,17,a.innertubeContextClientVersion);if(a.zb){var d=a.zb,e=new Ni;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Ni,62,e)}(d=z.devicePixelRatio)&&1!=d&&D(c,65,d);d=Fk();""!==d&&D(c,54,d);d=Gk();if(0<d.length){e=new Ti;for(var f=0;f<d.length;f++){var g=new Li;D(g,1,d[f].key);g.setValue(d[f].value);de(e,15,Li,
...
l.Qa=function(){var a=this;if(!Vn(this))throw sm("throttleSend");this.j||(this.j=this.aa.V(function(){var b;return x(function(c){if(1==c.i)return v(c,a.O.dc("NEW",a.I),2);if(3!=c.i)return b=c.j,b?v(c,Yn(a,b),3):(a.Sb(),c.return());a.j&&(a.j=0,a.Qa());c.i=0})},this.wc))};
l.Sb=function(){this.aa.ga(this.j);this.j=0};
...
!g&&a.potentialEsfErrorCounter>a.jb)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.B(8);break}return b.sendCount<a.sc?v(m,a.O.Ib(b.id,a.I),12):v(m,a.O.Da(b.id,a.I),8);case 12:a.aa.V(function(){a.M.W()&&a.Qa()},a.qc);
case 8:c(e,f),m.i=0}})};
...
function Xn(a){if(!Vn(a))throw sm("retryQueuedRequests");a.O.dc("QUEUED",a.I).then(function(b){b&&!$n(a,b,a.nc)?a.aa.V(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.B(2):v(c,a.O.Ib(b.id,a.I),2);Xn(a);c.i=0})}):a.M.W()&&a.Qa()})}
function Zn(a,b){a.Ac&&!a.M.W()?a.Ac(b):a.handleError(b)}
function Vn(a){return!!a.I||a.Za}
...
;var Bo={},Co=Bn("ServiceWorkerLogsDatabase",{Na:(Bo.SWHealthLog={qb:1},Bo),Kb:!0,upgrade:function(a,b){b(1)&&Hm(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
l.Tc=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
...
;var So;function To(){var a=Un.call;So||(So=new Qo({rr:!0,kr:!0}));a.call(Un,this,{O:{Kc:zo,Da:yo,dc:vo,Yc:wo,Ib:xo,set:to},M:So,handleError:Kk,Ea:Lk,ka:Uo,now:R,Ac:No,aa:Pl(),Fb:"publicytnetworkstatus-online",Eb:"publicytnetworkstatus-offline",fb:!0,cb:.1,jb:Ek("potential_esf_error_limit",10),J:M,La:!(Ql()&&Vo())});this.l=new Bh;M("networkless_immediately_drop_all_requests")&&Ao();yn("LogsDatabaseV2")}
u(To,Un);function Wo(){var a=B("yt.networklessRequestController.instance");a||(a=new To,A("yt.networklessRequestController.instance",a),M("networkless_logging")&&nn().then(function(b){a.I=b;Wn(a);a.l.resolve();a.fb&&Math.random()<=a.cb&&a.I&&Eo(a.I);M("networkless_immediately_drop_sw_health_store")&&Xo(a)}));
return a}
...
Kp.isNwlInitialized:lp)?mn().then(function(y){e(y)}):e(!1)}
...
function $p(a){var b=void 0===a?{}:a;a=void 0===b.dd?!1:b.dd;b=void 0===b.Pc?!0:b.Pc;if(null==B("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;A("_lact",c,window);A("_fact",c,window);-1==c&&aq();Vp(document,"keydown",aq);Vp(document,"keyup",aq);Vp(document,"mousedown",aq);Vp(document,"mouseup",aq);a?Vp(window,"touchmove",function(){bq("touchmove",200)},{passive:!0}):(Vp(window,"resize",function(){bq("resize",200)}),b&&Vp(window,"scroll",function(){bq("scroll",200)}));
...
a?wq.j=b:vq.j=b}
function Oq(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(R()),h=a.size,k={};a=p(a);for(var m=a.next();!m.done;k={Ta:k.Ta,sa:k.sa,Ga:k.Ga,Va:k.Va,Ua:k.Ua},m=a.next()){var q=p(m.value);m=q.next().value;q=q.next().value;k.sa=wb({context:Fn(b.config_||En())});if(!Pa(q)&&!M("throw_err_when_logevent_malformed_killswitch")){d();break}k.sa.events=q;(q=Bq[m])&&Sq(k.sa,m,q);delete Bq[m];k.Ga="visitorOnlyApprovedKey"===m;Tq(k.sa,g,k.Ga);Uq(e);k.Va=function(){h--;h||c()};
k.Ta=0;k.Ua=function(r){return function(){r.Ta++;if(e.bypassNetworkless&&1===r.Ta)try{Tn(b,"log_event",r.sa,Vq({writeThenSend:!0},r.Ga,r.Va,r.Ua,f)),yq=!1}catch(w){Kk(w),d()}h--;h||c()}}(k);
try{Tn(b,"log_event",k.sa,Vq(e,k.Ga,k.Va,k.Ua,f)),yq=!1}catch(r){Kk(r),d()}}}
function Qq(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(R()),g=a.size,h=new Map([].concat(ia(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new pk;var r=Ln(b.config_||En());G(k,Yi,1,r);q=q?Wq(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())de(k,3,jk,r.value);(q=Cq[m])&&Xq(k,m,q);delete Cq[m];m="visitorOnlyApprovedKey"===m;Yq(k,f,m);Uq(d);k=ie(k);m=Vq(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
...
function Vq(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,kc:a,Ka:b,gr:!!e,headers:{},postBodyFormat:"",postBody:""};Zq()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(R())));return a}
...
function Wq(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new jk(a[c]))}catch(d){Kk(new P("Transport failed to deserialize "+String(a[c])))}return b}
...
function br(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||R());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;M("enable_unknown_lact_fix_on_html5")&&$p();a=cq();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.ba&&(a=e.context,b=d.ba,b={index:cr(b),groupKey:b},a.sequence=b,d.Zb&&delete ar[d.ba]);(d.tc?Nq:Fq)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,Ka:d.Ka},c)}
function dr(a){Lq(void 0,void 0,void 0===a?!1:a)}
function cr(a){ar[a]=a in ar?ar[a]+1:0;return ar[a]}
;var er=z.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",er);function fr(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||R());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=cq();d=new ik;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.ba){e=c.ba;var f=cr(e),g=new Nj;D(g,2,f);D(g,1,e);G(d,Nj,3,g);c.Zb&&delete er[c.ba]}G(a,ik,33,d);(c.tc?Pq:Jq)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,Ka:c.Ka},b)}
;function gr(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);fr(a,c?null:Mp,b)}
;function hr(a,b){var c=new jk;be(c,Ej,72,kk,a);gr(c,b)}
function ir(a,b,c){var d=new jk;be(d,Dj,73,kk,a);c?fr(d,c,b):gr(d,b)}
function jr(a,b,c){var d=new jk;be(d,Cj,78,kk,a);c?fr(d,c,b):gr(d,b)}
function kr(a,b,c){var d=new jk;be(d,Fj,208,kk,a);c?fr(d,c,b):gr(d,b)}
function lr(a,b,c){var d=new jk;be(d,vj,156,kk,a);c?fr(d,c,b):gr(d,b)}
function mr(a,b,c){var d=new jk;be(d,zj,215,kk,a);c?fr(d,c,b):gr(d,b)}
function nr(a,b,c){var d=new jk;be(d,uj,111,kk,a);c?fr(d,c,b):gr(d,b)}
;function cm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts")){c=void 0===c?{}:c;var d=Mp;L("ytLoggingEventsDefaultDisabled",!1)&&Mp===Mp&&(d=null);M("web_all_payloads_via_jspb")&&Lk(new P("Logs should be translated to JSPB but are sent as JSON instead",a));br(a,b,d,c)}else d=Mp,L("ytLoggingEventsDefaultDisabled",!1)&&Mp==Mp&&(d=null),br(a,b,d,c)}
;var or=[{Cb:function(a){return"Cannot read property '"+a.key+"'"},
...
ib:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var qr={oa:[],na:[{callback:pr,weight:500}]};function pr(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function rr(){this.na=[];this.oa=[]}
var sr;function tr(){if(!sr){var a=sr=new rr;a.oa.length=0;a.na.length=0;qr.oa&&a.oa.push.apply(a.oa,qr.oa);qr.na&&a.na.push.apply(a.na,qr.na)}return sr}
;var ur=new K;function vr(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=wr(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=wr(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=wr(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function wr(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function xr(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=yr(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=vr(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?yr(e+".ve",f,g,h):0;d+=g;d+=yr(e,a[e],b,c);if(500<d)break}}else c[b]=zr(a),d+=c[b].length;else c[b]=zr(a),d+=c[b].length;return d}
function yr(a,b,c,d){c+="."+a;a=zr(b);d[c]=a;return c.length+a.length}
function zr(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var Ar=new Set,Br=0,Cr=0,Dr=0,Er=[],Fr=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function bm(a){Gr(a)}
function Hr(a){Gr(a,"WARNING")}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=Br)){var m=Er,q=Ae(a),r=q.message||"Unknown Error",w=q.name||"UnknownError",t=q.stack||a.j||"Not available";if(t.startsWith(w+": "+r)){var y=t.split("\n");y.shift();t=y.join("\n")}var E=q.lineNumber||"Not available",F=q.fileName||"Not available",O=t,N=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var Q=0;Q<a.args.length&&!(N=xr(a.args[Q],"params."+Q,g,N),500<=N);Q++);else if(a.hasOwnProperty("params")&&
a.params){var ca=a.params;if("object"===typeof a.params)for(var U in ca){if(ca[U]){var mb="params."+U,Xa=zr(ca[U]);g[mb]=Xa;N+=mb.length+Xa.length;if(500<N)break}}else g.params=zr(ca)}if(m.length)for(var na=0;na<m.length&&!(N=xr(m[na],"params.context."+na,g,N),500<=N);na++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:r,name:w,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},la=Number(a.columnNumber);isNaN(la)||(H.lineNumber=H.lineNumber+
":"+la);if("IGNORED"===a.level)var fa=0;else a:{for(var ve=tr(),we=p(ve.oa),pd=we.next();!pd.done;pd=we.next()){var pa=pd.value;if(H.message&&H.message.match(pa.sr)){fa=pa.weight;break a}}for(var Zo=p(ve.na),Oj=Zo.next();!Oj.done;Oj=Zo.next()){var $o=Oj.value;if($o.callback(H)){fa=$o.weight;break a}}fa=1}H.sampleWeight=fa;for(var ap=p(or),Pj=ap.next();!Pj.done;Pj=ap.next()){var Qj=Pj.value;if(Qj.ib[H.name])for(var bp=p(Qj.ib[H.name]),Rj=bp.next();!Rj.done;Rj=bp.next()){var cp=Rj.value,Kg=H.message.match(cp.regexp);
if(Kg){H.params["params.error.original"]=Kg[0];for(var Sj=cp.groups,dp={},qd=0;qd<Sj.length;qd++)dp[Sj[qd]]=Kg[qd+1],H.params["params.error."+Sj[qd]]=Kg[qd+1];H.message=Qj.Cb(dp);break}}}H.params||(H.params={});var ep=tr();H.params["params.errorServiceSignature"]="msg="+ep.oa.length+"&cb="+ep.na.length;H.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Ar.has(H.message)){if("ERROR"===h){ur.ta("handleError",H);if(M("record_app_crashed_web")&&0===Dr&&1===H.sampleWeight)if(Dr++,M("errors_via_jspb")){var Tj=new rj;D(Tj,1,1);if(!M("report_client_error_with_app_crash_ks")){var fp=new mj;D(fp,1,H.message);var gp=new nj;G(gp,mj,3,fp);var hp=new oj;G(hp,nj,5,gp);var ip=new pj;G(ip,oj,9,hp);G(Tj,pj,4,ip)}var jp=new jk;be(jp,rj,20,
kk,Tj);gr(jp)}else{var kp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(kp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});cm("appCrashed",kp)}Cr++}else"WARNING"===h&&ur.ta("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var xe=h;if(M("errors_via_jspb")){if(Ir())var mp=void 0;else{var rd=new jj;D(rd,1,H.stack);H.fileName&&D(rd,4,H.fileName);var Fb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Fb.length&&(1!==
Fb.length||isNaN(Number(Fb[0]))?2!==Fb.length||isNaN(Number(Fb[0]))||isNaN(Number(Fb[1]))||(D(rd,2,Number(Fb[0])),D(rd,3,Number(Fb[1]))):D(rd,2,Number(Fb[0])));var xc=new mj;D(xc,1,H.message);D(xc,3,H.name);D(xc,6,H.sampleWeight);"ERROR"===xe?D(xc,2,2):"WARNING"===xe?D(xc,2,1):D(xc,2,0);var Uj=new kj;D(Uj,1,!0);be(Uj,jj,3,lj,rd);var Yb=new gj;D(Yb,3,window.location.href);for(var np=L("FEXP_EXPERIMENTS",[]),Vj=0;Vj<np.length;Vj++){var Dv=np[Vj];Ld(Yb);Vd(Yb,5,2,!1).push(Dv)}var Wj=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Ck()&&Wj)for(var op=p(Object.keys(Wj)),yc=op.next();!yc.done;yc=op.next()){var pp=yc.value,Xj=new ij;D(Xj,1,pp);Xj.setValue(String(Wj[pp]));de(Yb,4,ij,Xj)}var Yj=H.params;if(Yj){var qp=p(Object.keys(Yj));for(yc=qp.next();!yc.done;yc=qp.next()){var rp=yc.value,Zj=new ij;D(Zj,1,"client."+rp);Zj.setValue(String(Yj[rp]));de(Yb,4,ij,Zj)}}var sp=L("SERVER_NAME"),tp=L("SERVER_VERSION");if(sp&&tp){var ak=new ij;D(ak,1,"server.name");ak.setValue(sp);de(Yb,4,ij,ak);var bk=new ij;D(bk,1,"server.version");
bk.setValue(tp);de(Yb,4,ij,bk)}var Lg=new nj;G(Lg,gj,1,Yb);G(Lg,kj,2,Uj);G(Lg,mj,3,xc);mp=Lg}var up=mp;if(!up)break a;var vp=new jk;be(vp,nj,163,kk,up);gr(vp)}else{if(Ir())var wp=void 0;else{var ye={stackTrace:H.stack};H.fileName&&(ye.filename=H.fileName);var Gb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Gb.length&&(1!==Gb.length||isNaN(Number(Gb[0]))?2!==Gb.length||isNaN(Number(Gb[0]))||isNaN(Number(Gb[1]))||(ye.lineNumber=Number(Gb[0]),ye.columnNumber=Number(Gb[1])):ye.lineNumber=
Number(Gb[0]));var ck={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===xe?ck.level="ERROR_LEVEL_ERROR":"WARNING"===xe&&(ck.level="ERROR_LEVEL_WARNNING");var Ev={isObfuscated:!0,browserStackInfo:ye},sd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(sd.experimentIds=L("FEXP_EXPERIMENTS"));var dk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Ck()&&dk)for(var xp=p(Object.keys(dk)),zc=xp.next();!zc.done;zc=xp.next()){var yp=
zc.value;sd.kvPairs.push({key:yp,value:String(dk[yp])})}var ek=H.params;if(ek){var zp=p(Object.keys(ek));for(zc=zp.next();!zc.done;zc=zp.next()){var Ap=zc.value;sd.kvPairs.push({key:"client."+Ap,value:String(ek[Ap])})}}var Bp=L("SERVER_NAME"),Cp=L("SERVER_VERSION");Bp&&Cp&&(sd.kvPairs.push({key:"server.name",value:Bp}),sd.kvPairs.push({key:"server.version",value:Cp}));wp={errorMetadata:sd,stackTrace:Ev,logMessage:ck}}var Dp=wp;if(!Dp)break a;cm("clientError",Dp)}if("ERROR"===xe||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
(dr(!0),!M("web_fp_via_jspb_and_json")))break c;dr()}else{if(M("web_fp_via_jspb")&&(dr(!0),!M("web_fp_via_jspb_and_json")))break b;dr()}}if(!M("suppress_error_204_logging")){var ze=H.params||{},Zb={urlParams:{a:"logerror",t:"jserror",type:H.name,msg:H.message.substr(0,250),line:H.lineNumber,level:h,"client.name":ze.name},postParams:{url:L("PAGE_NAME",window.location.href),file:H.fileName},method:"POST"};ze.version&&(Zb["client.version"]=ze.version);if(Zb.postParams){H.stack&&(Zb.postParams.stack=
H.stack);for(var Ep=p(Object.keys(ze)),fk=Ep.next();!fk.done;fk=Ep.next()){var Fp=fk.value;Zb.postParams["client."+Fp]=ze[Fp]}var gk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(gk)for(var Gp=p(Object.keys(gk)),hk=Gp.next();!hk.done;hk=Gp.next()){var Hp=hk.value;Zb.postParams[Hp]=gk[Hp]}var Ip=L("SERVER_NAME"),Jp=L("SERVER_VERSION");Ip&&Jp&&(Zb.postParams["server.name"]=Ip,Zb.postParams["server.version"]=Jp)}jl(L("ECATCHER_REPORT_HOST","")+"/error_204",Zb)}try{Ar.add(H.message)}catch(hx){}Br++}}}}
function Ir(){for(var a=p(Fr),b=a.next();!b.done;b=a.next())if(Tl(b.value.toLowerCase()))return!0;return!1}
function Jr(a){var b=Ja.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,ia(b))}
;function Kr(){this.register=new Map}
function Lr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.vr("ABORTED")}
Kr.prototype.clear=function(){Lr(this);this.register.clear()};
var Mr=new Kr;var Nr=Date.now().toString();
function Or(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=Date.now();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Nr)for(a=1,b=0;b<Nr.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Nr.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Pr=z.ytLoggingDocDocumentNonce_;Pr||(Pr=Or(),A("ytLoggingDocDocumentNonce_",Pr));var Qr=Pr;var Rr={Zh:0,te:1,Ee:2,Wl:3,bi:4,uq:5,Mm:6,zo:7,Rn:8,no:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function Sr(a){this.G=a}
function Tr(a){return new Sr({trackingParams:a})}
Sr.prototype.getAsJson=function(){var a={};void 0!==this.G.trackingParams?a.trackingParams=this.G.trackingParams:(a.veType=this.G.veType,void 0!==this.G.veCounter&&(a.veCounter=this.G.veCounter),void 0!==this.G.elementIndex&&(a.elementIndex=this.G.elementIndex));void 0!==this.G.dataElement&&(a.dataElement=this.G.dataElement.getAsJson());void 0!==this.G.youtubeData&&(a.youtubeData=this.G.youtubeData);return a};
Sr.prototype.getAsJspb=function(){var a=new tj;if(void 0!==this.G.trackingParams){var b=this.G.trackingParams;if(null!=b)if("string"===typeof b)b=b?new nd(b,kd):od();else if(b.constructor!==nd)if(jd(b))b=b.length?new nd(new Uint8Array(b),kd):od();else throw Error();D(a,1,b)}else void 0!==this.G.veType&&D(a,2,this.G.veType),void 0!==this.G.veCounter&&D(a,6,this.G.veCounter),void 0!==this.G.elementIndex&&D(a,3,this.G.elementIndex);void 0!==this.G.dataElement&&(b=this.G.dataElement.getAsJspb(),G(a,tj,
7,b));void 0!==this.G.youtubeData&&G(a,Ki,8,this.G.jspbYoutubeData);return a};
Sr.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
Sr.prototype.isClientVe=function(){return!this.G.trackingParams&&!!this.G.veType};function Ur(a){a=void 0===a?0:a;return 0===a?"client-screen-nonce":"client-screen-nonce."+a}
function Vr(a){a=void 0===a?0:a;return 0===a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Wr(a){return L(Vr(void 0===a?0:a))}
A("yt_logging_screen.getRootVeType",Wr);function Xr(a){return(a=Wr(void 0===a?0:a))?new Sr({veType:a,youtubeData:void 0,jspbYoutubeData:void 0}):null}
function Yr(){var a=L("csn-to-ctt-auth-info");a||(a={},Bk("csn-to-ctt-auth-info",a));return a}
function Zr(a){a=L(Ur(void 0===a?0:a));if(!a&&!L("USE_CSN_FALLBACK",!0))return null;a||(a="UNDEFINED_CSN");return a?a:null}
A("yt_logging_screen.getCurrentCsn",Zr);function $r(a,b,c){var d=Yr();(c=Zr(c))&&delete d[c];b&&(d[a]=b)}
function as(a){return Yr()[a]}
A("yt_logging_screen.getCttAuthInfo",as);
function bs(a,b,c,d){c=void 0===c?0:c;if(a!==L(Ur(c))||b!==L(Vr(c)))if($r(a,d,c),Bk(Ur(c),a),Bk(Vr(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new uj;D(e,1,Qr);D(e,2,a);M("use_default_heartbeat_client")?nr(e):nr(e,void 0,Mp)}else e={clientDocumentNonce:Qr,clientScreenNonce:a},M("use_default_heartbeat_client")?cm("foregroundHeartbeatScreenAssociated",e):br("foregroundHeartbeatScreenAssociated",e,Mp)},0)},"requestAnimationFrame"in window)try{window.requestAnimationFrame(b)}catch(e){b()}else b()}
A("yt_logging_screen.setCurrentScreen",bs);var cs=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};A("yt.msgs_",cs);function ds(a){wk(cs,arguments)}
;var es={se:3611,Dd:27686,Ed:85013,Fd:23462,Hd:157557,Id:42016,Jd:62407,Kd:26926,Gd:43781,Ld:51236,Md:79148,Nd:50160,Od:77504,ae:153587,be:87907,ce:18630,de:54445,ee:80935,ge:152172,he:105675,ie:150723,je:37521,ke:147285,le:47786,me:98349,ne:123695,oe:6827,pe:29434,qe:7282,re:124448,we:32276,ue:76278,xe:147868,ye:147869,ze:93911,Ae:106531,Be:27259,Ce:27262,De:27263,Fe:21759,Ge:27107,He:62936,Ie:160866,Je:49568,Ke:160789,Le:38408,Me:80637,Ne:68727,Oe:68728,Pe:80353,Qe:80356,Re:74610,Se:45707,Te:83962,
...
mq:53969,nq:8213,oq:93926,pq:102852,qq:110099,rq:22678,sq:69076,tq:137575,wq:139224,xq:100856,yq:154430,zq:17736,Aq:3832,Bq:147111,Cq:55759,Dq:64031,Jq:93044,Kq:93045,Lq:34388,Mq:17657,Nq:17655,Oq:39579,Pq:39578,Qq:77448,Rq:8196,Sq:11357,Tq:69877,Uq:8197,Vq:156512,Wq:161613,Xq:156509,Yq:161612,Zq:161614,br:82039};function fs(){var a=vb(gs),b;return(new yf(function(c,d){a.onSuccess=function(e){cl(e)?c(new hs(e)):d(new is("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return Df(c)})}
function is(a,b,c){ab.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
u(is,ab);function hs(a){this.xhr=a}
;function js(){this.i=0;this.da=null}
js.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.da))&&"function"===typeof a.then?a:ks(a):2===this.i&&b?(a=b.call(c,this.da))&&"function"===typeof a.then?a:ls(a):this};
js.prototype.getValue=function(){return this.da};
js.prototype.$goog_Thenable=!0;function ls(a){var b=new js;a=void 0===a?null:a;b.i=2;b.da=void 0===a?null:a;return b}
function ks(a){var b=new js;a=void 0===a?null:a;b.i=1;b.da=void 0===a?null:a;return b}
;function ms(a,b){if(a)return a[b.name]}
;function ns(a,b){var c=void 0===c?{}:c;a={method:void 0===b?"POST":b,mode:Yk(a)?"same-origin":"cors",credentials:Yk(a)?"same-origin":"include"};b={};for(var d=p(Object.keys(c)),e=d.next();!e.done;e=d.next())e=e.value,c[e]&&(b[e]=c[e]);0<Object.keys(b).length&&(a.headers=b);return a}
;function os(){return sg()||Sl&&Tl("applewebkit")&&!Tl("version")&&(!Tl("safari")||Tl("gsa/"))||Pc&&Tl("version/")?!0:L("EOM_VISITOR_DATA")?!1:!0}
;function ps(a){a:{var b=a.raw_embedded_player_response;if(!b&&(a=a.embedded_player_response))try{b=JSON.parse(a)}catch(d){b="EMBEDDED_PLAYER_MODE_UNKNOWN";break a}if(b)b:{for(var c in dj)if(dj[c]==b.embeddedPlayerMode){b=dj[c];break b}b="EMBEDDED_PLAYER_MODE_UNKNOWN"}else b="EMBEDDED_PLAYER_MODE_UNKNOWN"}return"EMBEDDED_PLAYER_MODE_PFL"===b}
;function qs(a){ab.call(this,a.message||a.description||a.name);this.isMissing=a instanceof rs;this.isTimeout=a instanceof is&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ff}
u(qs,ab);qs.prototype.name="BiscottiError";function rs(){ab.call(this,"Biscotti ID is missing from server")}
u(rs,ab);rs.prototype.name="BiscottiMissingError";var gs={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ss=null;function ts(){if(M("disable_biscotti_fetch_entirely_for_all_web_clients"))return Error("Biscotti id fetching has been disabled entirely.");if(!os())return Error("User has not consented - not fetching biscotti id.");var a=L("PLAYER_VARS",{});if("1"==tb(a))return Error("Biscotti ID is not available in private embed mode");if(ps(a))return Error("Biscotti id fetching has been disabled for pfl.")}
function Nk(){var a=ts();if(void 0!==a)return Df(a);ss||(ss=fs().then(us).nb(function(b){return vs(2,b)}));
return ss}
function us(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new rs;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new rs;a=a.id;Ok(a);ss=ks(a);ws(18E5,2);return a}
function vs(a,b){b=new qs(b);Ok("");ss=ls(b);0<a&&ws(12E4,a-1);throw b;}
function ws(a,b){dl(function(){fs().then(us,function(c){return vs(b,c)}).nb(cb)},a)}
function xs(){try{var a=B("yt.ads.biscotti.getId_");return a?a():Nk()}catch(b){return Df(b)}}
;function ys(a){if("1"!=tb(L("PLAYER_VARS",{}))){a&&Mk();try{xs().then(function(){},function(){}),dl(ys,18E5)}catch(b){Kk(b)}}}
;function zs(){this.vd=!0}
function As(a){var b={},c=ug([]);c&&(b.Authorization=c,c=a=null==a?void 0:a.sessionIndex,void 0===c&&(c=Number(L("SESSION_INDEX",0)),c=isNaN(c)?0:c),M("voice_search_auth_header_removal")||(b["X-Goog-AuthUser"]=c),"INNERTUBE_HOST_OVERRIDE"in Ak||(b["X-Origin"]=window.location.origin),void 0===a&&"DELEGATED_SESSION_ID"in Ak&&(b["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return b}
;var Bs={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var Cs=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]);function Ds(){var a=void 0===a?window.location.href:a;if(M("kevlar_disable_theme_param"))return null;mc(nc(5,a));try{var b=Wk(a).theme;return Cs.get(b)||null}catch(c){}return null}
;function Es(){this.i={};if(this.j=vl()){var a=qg.get("CONSISTENCY",void 0);a&&Fs(this,{encryptedTokenJarContents:a})}}
Es.prototype.handleResponse=function(a,b){if(!b)throw Error("request needs to be passed into ConsistencyService");var c,d;b=(null==(c=b.ia.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;if(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar){e=p(b);for(c=e.next();!c.done;c=e.next())delete this.i[c.value.encryptedTokenJarContents];Fs(this,a)}};
function Fs(a,b){if(b.encryptedTokenJarContents&&(a.i[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.i[b.encryptedTokenJarContents]},1E3*c);
a.j&&tl("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var Gs=window.location.hostname.split(".").slice(-2).join(".");function Hs(){var a=L("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===L("INNERTUBE_CLIENT_NAME")&&(this.i=Is(this))&&(a=this.i.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.j=void 0)}
var Js;Hs.getInstance=function(){Js=B("yt.clientLocationService.instance");Js||(Js=new Hs,A("yt.clientLocationService.instance",Js));return Js};
l=Hs.prototype;l.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.j?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=Math.floor(1E7*this.j.coords.latitude),a.client.locationInfo.longitudeE7=Math.floor(1E7*this.j.coords.longitude),a.client.locationInfo.horizontalAccuracyMeters=Math.round(this.j.coords.accuracy),a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
l.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.j=void 0,"TVHTML5"===L("INNERTUBE_CLIENT_NAME")?(this.i=Is(this))&&this.i.set("yt-location-playability-token",a,15552E3):tl("YT_CL",JSON.stringify({loctok:a}),15552E3,Gs,!0))};
function Is(a){return void 0===a.i?new Ul("yt-client-location"):a.i}
l.clearLocationPlayabilityToken=function(a){"TVHTML5"===a?(this.i=Is(this))&&this.i.remove("yt-location-playability-token"):ul("YT_CL")};
...
l.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null==a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null==a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null==a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function Ks(a,b){var c,d=null==(c=ms(a,cj))?void 0:c.signal;if(d&&b.Pa&&(c=b.Pa[d]))return c();var e;if((c=null==(e=ms(a,aj))?void 0:e.request)&&b.Mc&&(e=b.Mc[c]))return e();for(var f in a)if(b.Vb[f]&&(a=b.Vb[f]))return a()}
;var Ls=Symbol("injectionDeps");function Ms(a){this.name=a}
Ms.prototype.toString=function(){return"InjectionToken("+this.name+")"};
function Ns(){this.key=Os}
function Ps(){this.providers=new Map;this.i=new Map}
Ps.prototype.resolve=function(a){return a instanceof Ns?Qs(this,a.key,[],!0):Qs(this,a,[])};
function Qs(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.zc)var e=d.zc;else if(d.Cd)e=d[Ls]?Rs(a,d[Ls],c):[],e=d.Cd.apply(d,ia(e));else if(d.yc){e=d.yc;var f=e[Ls]?Rs(a,e[Ls],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ia(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.Ar||a.i.set(b,e);
return e}
...
;function Us(a){return function(){return new a}}
;var Vs={},Ws=(Vs.WEB_UNPLUGGED="^unplugged/",Vs.WEB_UNPLUGGED_ONBOARDING="^unplugged/",Vs.WEB_UNPLUGGED_OPS="^unplugged/",Vs.WEB_UNPLUGGED_PUBLIC="^unplugged/",Vs.WEB_CREATOR="^creator/",Vs.WEB_KIDS="^kids/",Vs.WEB_EXPERIMENTS="^experiments/",Vs.WEB_MUSIC="^music/",Vs.WEB_REMIX="^music/",Vs.WEB_MUSIC_EMBEDDED_PLAYER="^music/",Vs.WEB_MUSIC_EMBEDDED_PLAYER="^main_app/|^sfv/",Vs);
function Xs(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=Ws[b];if(c){var d=new RegExp(c),e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(Ws).forEach(function(g){var h=p(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function Ys(){}
Ys.prototype.o=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?Bs:c;var d=a.clickTrackingParams,e=this.m,f=!1;f=void 0===f?!1:f;e=void 0===e?!1:e;var g=L("INNERTUBE_CONTEXT");if(g){g=wb(g);M("web_no_tracking_params_in_shell_killswitch")||delete g.clickTracking;g.client||(g.client={});var h=g.client;"MWEB"===h.clientName&&(h.clientFormFactor=L("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");h.screenWidthPoints=window.innerWidth;h.screenHeightPoints=window.innerHeight;h.screenPixelDensity=Math.round(window.devicePixelRatio||
1);h.screenDensityFloat=window.devicePixelRatio||1;h.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var k=void 0===k?!1:k;xl.getInstance();var m="USER_INTERFACE_THEME_LIGHT";Al(165)?m="USER_INTERFACE_THEME_DARK":Al(174)?m="USER_INTERFACE_THEME_LIGHT":!M("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(m="USER_INTERFACE_THEME_DARK");k=k?m:Ds()||m;h.userInterfaceTheme=k;if(!f){if(k=
...
{},{certificationScope:r}));if(!M("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var w=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(mb){}w=void 0}w&&(h.timeZone=w)}(w=Fk())?h.experimentsToken=w:delete h.experimentsToken;w=Gk();Es.i||(Es.i=new Es);h=Es.i.i;r=[];q=0;for(var t in h)r[q++]=h[t];g.request=Object.assign({},g.request,{internalExperimentFlags:w,consistencyTokenJars:r});!M("web_prequest_context_killswitch")&&(t=L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&
(g.request.externalPrequestContext=t);w=xl.getInstance();t=Al(58);w=w.get("gsml","");g.user=Object.assign({},g.user);t&&(g.user.enableSafetyMode=t);w&&(g.user.lockedSafetyMode=!0);M("warm_op_csn_cleanup")?e&&(f=Zr())&&(g.clientScreenNonce=f):!f&&(f=Zr())&&(g.clientScreenNonce=f);d&&(g.clickTracking={clickTrackingParams:d});if(d=B("yt.mdx.remote.remoteClient_"))g.remoteClient=d;Hs.getInstance().setLocationOnInnerTubeContext(g);try{var y=Zk(),E=y.bid;delete y.bid;g.adSignalsInfo={params:[],bid:E};var F=
p(Object.entries(y));for(var O=F.next();!O.done;O=F.next()){var N=p(O.value),Q=N.next().value,ca=N.next().value;y=Q;E=ca;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:y,value:""+E})}}catch(mb){Gr(mb)}F=g}else Gr(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(O=this.i(a)){this.j(F,O,b);var U;b="/youtubei/v1/"+Xs(this.l());(O=null==(U=ms(a.commandMetadata,bj))?void 0:U.apiUrl)&&(b=O);U=b;(b=L("INNERTUBE_HOST_OVERRIDE"))&&(U=String(b)+String(pc(U)));b=
{};b.key=L("INNERTUBE_API_KEY");M("json_condensed_response")&&(b.prettyPrint="false");U=Xk(U,b||{},!1);a=Object.assign({},{command:a},void 0);a={input:U,za:ns(U),ia:F,config:a};a.config.Ya?a.config.Ya.identity=c:a.config.Ya={identity:c};return a}Gr(new P("Error: Failed to create Request from Command.",a))};
ea.Object.defineProperties(Ys.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function Zs(){}
u(Zs,Ys);Zs.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",za:ns("/getDatasyncIdsEndpoint","GET"),ia:{}}};
Zs.prototype.l=function(){return[]};
Zs.prototype.i=function(){};
Zs.prototype.j=function(){};var $s={},at=($s.GET_DATASYNC_IDS=Us(Zs),$s);function bt(a){var b=Ja.apply(1,arguments);if(!ct(a)||b.some(function(d){return!ct(d)}))throw Error("Only objects may be merged.");
b=p(b);for(var c=b.next();!c.done;c=b.next())dt(a,c.value);return a}
function dt(a,b){for(var c in b)if(ct(b[c])){if(c in a&&!ct(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});dt(a[c],b[c])}else if(et(b[c])){if(c in a&&!et(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);ft(a[c],b[c])}else a[c]=b[c];return a}
function ft(a,b){b=p(b);for(var c=b.next();!c.done;c=b.next())c=c.value,ct(c)?a.push(dt({},c)):et(c)?a.push(ft([],c)):a.push(c);return a}
function ct(a){return"object"===typeof a&&!Array.isArray(a)}
function et(a){return"object"===typeof a&&Array.isArray(a)}
;function gt(a,b){co.call(this,1,arguments);this.timer=b}
u(gt,co);var ht=new eo("aft-recorded",gt);var jt=window;function kt(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var S=jt.performance||jt.mozPerformance||jt.msPerformance||jt.webkitPerformance||new kt;var lt=!1,mt={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"};
Wa(S.clearResourceTimings||S.webkitClearResourceTimings||S.mozClearResourceTimings||S.msClearResourceTimings||S.oClearResourceTimings||cb,S);function nt(a){var b=ot("aft",a);if(b)return b;b=L((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=b.length,d=0;d<c;d++){var e=ot(b[d],a);if(e)return e}return NaN}
function pt(){var a;if(M("csi_use_performance_navigation_timing")||M("csi_use_performance_navigation_timing_tvhtml5")){var b,c,d,e=null==S?void 0:null==(a=S.getEntriesByType)?void 0:null==(b=a.call(S,"navigation"))?void 0:null==(c=b[0])?void 0:null==(d=c.toJSON)?void 0:d.call(c);e?(e.requestStart=qt(e.requestStart),e.responseEnd=qt(e.responseEnd),e.redirectStart=qt(e.redirectStart),e.redirectEnd=qt(e.redirectEnd),e.domainLookupEnd=qt(e.domainLookupEnd),e.connectStart=qt(e.connectStart),e.connectEnd=
qt(e.connectEnd),e.responseStart=qt(e.responseStart),e.secureConnectionStart=qt(e.secureConnectionStart),e.domainLookupStart=qt(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=S.timing}else a=S.timing;return a}
function rt(){return(M("csi_use_time_origin")||M("csi_use_time_origin_tvhtml5"))&&S.timeOrigin?Math.floor(S.timeOrigin):S.timing.navigationStart}
function qt(a){return Math.round(rt()+a)}
function st(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},A("ytcsi."+(a||"")+"data_",b));return b}
function tt(a){a=st(a);a.info||(a.info={});return a.info}
function ut(a){a=st(a);a.metadata||(a.metadata={});return a.metadata}
function vt(a){a=st(a);a.tick||(a.tick={});return a.tick}
function ot(a,b){if(a=vt(b)[a])return"number"===typeof a?a:a[a.length-1]}
function wt(a){a=st(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
function xt(a){a=wt(a);a.gelInfos||(a.gelInfos={});return a.gelInfos}
function zt(a){var b=st(a).nonce;b||(b=Or(),st(a).nonce=b);return b}
function At(a){var b=ot("_start",a),c=nt(a);b&&c&&!lt&&(jo(ht,new gt(Math.round(c-b),a)),lt=!0)}
function Bt(a,b){for(var c=p(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!Bt(a[d],b[d]))return!1;return!0}
;function Ct(){if(S.getEntriesByType){var a=S.getEntriesByType("paint");if(a=kb(a,function(b){return"first-paint"===b.name}))return qt(a.startTime)}a=S.timing;
return a.Zc?Math.max(0,a.Zc):0}
;function Dt(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a),A("ytcsi.reference",{}));return a}
function Et(a){a=a||"";var b=B("ytcsi.reference");b||(Dt(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=Dt(),d={timerName:a,info:{},tick:{},span:{},jspbInfo:[]};c.push(d);return b[a]=d}
;var T={},Ft=(T.auto_search="LATENCY_ACTION_AUTO_SEARCH",T.ad_to_ad="LATENCY_ACTION_AD_TO_AD",T.ad_to_video="LATENCY_ACTION_AD_TO_VIDEO",T["analytics.explore"]="LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE",T.app_startup="LATENCY_ACTION_APP_STARTUP",T["artist.analytics"]="LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS",T["artist.events"]="LATENCY_ACTION_CREATOR_ARTIST_CONCERTS",T["artist.presskit"]="LATENCY_ACTION_CREATOR_ARTIST_PROFILE",T["song.analytics"]="LATENCY_ACTION_CREATOR_SONG_ANALYTICS",T.browse="LATENCY_ACTION_BROWSE",
...
Ht="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),It={},Jt=(It.ccs="CANARY_STATE_",It.mver="MEASUREMENT_VERSION_",It.pis="PLAYER_INITIALIZED_STATE_",It.yt_pt="LATENCY_PLAYER_",It.pa="LATENCY_ACTION_",It.ctop="TOP_ENTITY_TYPE_",
It.yt_vst="VIDEO_STREAM_TYPE_",It),Kt="all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");function Lt(a){return Ft[a]||"LATENCY_ACTION_UNKNOWN"}
function Mt(a,b,c){c=wt(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Gt){c=Gt[a];0<=eb(Ht,c)&&(b=!!b);a in Jt&&"string"===typeof b&&(b=Jt[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return bt({},d)}0<=eb(Kt,a)||Hr(new P("Unknown label logged with GEL CSI",a))}
...
Y[Y.DETAILED_NETWORK_TYPE_1_X_RTT]="DETAILED_NETWORK_TYPE_1_X_RTT";Y[Y.DETAILED_NETWORK_TYPE_GPRS]="DETAILED_NETWORK_TYPE_GPRS";Y[Y.DETAILED_NETWORK_TYPE_EDGE]="DETAILED_NETWORK_TYPE_EDGE";Y[Y.DETAILED_NETWORK_TYPE_UNKNOWN]="DETAILED_NETWORK_TYPE_UNKNOWN";var Ot={LATENCY_PLAYER_RTSP:7,LATENCY_PLAYER_HTML5_INLINE:6,LATENCY_PLAYER_HTML5_FULLSCREEN:5,LATENCY_PLAYER_HTML5:4,LATENCY_PLAYER_FRAMEWORK:3,LATENCY_PLAYER_FLASH:2,LATENCY_PLAYER_EXO:1,LATENCY_PLAYER_UNKNOWN:0};Ot[Ot.LATENCY_PLAYER_RTSP]="LATENCY_PLAYER_RTSP";
Ot[Ot.LATENCY_PLAYER_HTML5_INLINE]="LATENCY_PLAYER_HTML5_INLINE";Ot[Ot.LATENCY_PLAYER_HTML5_FULLSCREEN]="LATENCY_PLAYER_HTML5_FULLSCREEN";Ot[Ot.LATENCY_PLAYER_HTML5]="LATENCY_PLAYER_HTML5";Ot[Ot.LATENCY_PLAYER_FRAMEWORK]="LATENCY_PLAYER_FRAMEWORK";Ot[Ot.LATENCY_PLAYER_FLASH]="LATENCY_PLAYER_FLASH";Ot[Ot.LATENCY_PLAYER_EXO]="LATENCY_PLAYER_EXO";Ot[Ot.LATENCY_PLAYER_UNKNOWN]="LATENCY_PLAYER_UNKNOWN";
var Pt={LATENCY_AD_BREAK_TYPE_POSTROLL:3,LATENCY_AD_BREAK_TYPE_MIDROLL:2,LATENCY_AD_BREAK_TYPE_PREROLL:1,LATENCY_AD_BREAK_TYPE_UNKNOWN:0};Pt[Pt.LATENCY_AD_BREAK_TYPE_POSTROLL]="LATENCY_AD_BREAK_TYPE_POSTROLL";Pt[Pt.LATENCY_AD_BREAK_TYPE_MIDROLL]="LATENCY_AD_BREAK_TYPE_MIDROLL";Pt[Pt.LATENCY_AD_BREAK_TYPE_PREROLL]="LATENCY_AD_BREAK_TYPE_PREROLL";Pt[Pt.LATENCY_AD_BREAK_TYPE_UNKNOWN]="LATENCY_AD_BREAK_TYPE_UNKNOWN";var Qt={LATENCY_ACTION_ERROR_STARTUP_TIMEOUT:1,LATENCY_ACTION_ERROR_UNSPECIFIED:0};
Qt[Qt.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT]="LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";Qt[Qt.LATENCY_ACTION_ERROR_UNSPECIFIED]="LATENCY_ACTION_ERROR_UNSPECIFIED";var Rt={LIVE_STREAM_MODE_WINDOW:5,LIVE_STREAM_MODE_POST:4,LIVE_STREAM_MODE_LP:3,LIVE_STREAM_MODE_LIVE:2,LIVE_STREAM_MODE_DVR:1,LIVE_STREAM_MODE_UNKNOWN:0};Rt[Rt.LIVE_STREAM_MODE_WINDOW]="LIVE_STREAM_MODE_WINDOW";Rt[Rt.LIVE_STREAM_MODE_POST]="LIVE_STREAM_MODE_POST";Rt[Rt.LIVE_STREAM_MODE_LP]="LIVE_STREAM_MODE_LP";
Rt[Rt.LIVE_STREAM_MODE_LIVE]="LIVE_STREAM_MODE_LIVE";Rt[Rt.LIVE_STREAM_MODE_DVR]="LIVE_STREAM_MODE_DVR";Rt[Rt.LIVE_STREAM_MODE_UNKNOWN]="LIVE_STREAM_MODE_UNKNOWN";var St={VIDEO_STREAM_TYPE_VOD:3,VIDEO_STREAM_TYPE_DVR:2,VIDEO_STREAM_TYPE_LIVE:1,VIDEO_STREAM_TYPE_UNSPECIFIED:0};St[St.VIDEO_STREAM_TYPE_VOD]="VIDEO_STREAM_TYPE_VOD";St[St.VIDEO_STREAM_TYPE_DVR]="VIDEO_STREAM_TYPE_DVR";St[St.VIDEO_STREAM_TYPE_LIVE]="VIDEO_STREAM_TYPE_LIVE";St[St.VIDEO_STREAM_TYPE_UNSPECIFIED]="VIDEO_STREAM_TYPE_UNSPECIFIED";
var Tt={YT_IDB_TRANSACTION_TYPE_READ:2,YT_IDB_TRANSACTION_TYPE_WRITE:1,YT_IDB_TRANSACTION_TYPE_UNKNOWN:0};Tt[Tt.YT_IDB_TRANSACTION_TYPE_READ]="YT_IDB_TRANSACTION_TYPE_READ";Tt[Tt.YT_IDB_TRANSACTION_TYPE_WRITE]="YT_IDB_TRANSACTION_TYPE_WRITE";Tt[Tt.YT_IDB_TRANSACTION_TYPE_UNKNOWN]="YT_IDB_TRANSACTION_TYPE_UNKNOWN";var Ut={PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN:2,PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT:1,PLAYER_ROTATION_TYPE_UNKNOWN:0};Ut[Ut.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN]="PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
Ut[Ut.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT]="PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";Ut[Ut.PLAYER_ROTATION_TYPE_UNKNOWN]="PLAYER_ROTATION_TYPE_UNKNOWN";var Vt="actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo webViewInfo prefetchInfo accelerationSession commerceInfo webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");var Wt=z.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",Wt);function Xt(){this.i=0}
function Yt(){Xt.i||(Xt.i=new Xt);return Xt.i}
Xt.prototype.tick=function(a,b,c,d){Zt(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Mj,D(d,1,a),D(d,2,b),a=new jk,be(a,Mj,5,kk,d),gr(a,c)):cm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
Xt.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Zt(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,cm("latencyActionInfo",a,{cttAuthInfo:c}))};
Xt.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Zt(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new jk,be(c,Ij,7,kk,a),gr(c,b))};
Xt.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Zt(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,cm("latencyActionSpan",a,{cttAuthInfo:c}))};
function Zt(a,b){Wt[b]=Wt[b]||{count:0};var c=Wt[b];c.count++;c.time=R();a.i||(a.i=Kl(function(){var d=R(),e;for(e in Wt)Wt[e]&&6E4<d-Wt[e].time&&delete Wt[e];a&&(a.i=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new P("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Hr(c)),!0):!1}
;function $t(){var a=["ol"];Et("").info.actionType="embed";a&&Bk("TIMING_AFT_KEYS",a);Bk("TIMING_ACTION","embed");if(M("web_csi_via_jspb")){a=L("TIMING_INFO",{});var b=new Ij;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetGuide_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetHome_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);
break;case "GetPlayer_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetSearch_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetSettings_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetTrending_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "GetWatchNext_rid":e=new Lj;D(e,1,c);D(e,2,String(d));Kj(b,e);break;case "yt_red":D(b,14,!!d);break;case "yt_ad":D(b,9,!!d)}}au(b);b=new Ij;b=D(b,25,!0);b=D(b,1,W[Lt(L("TIMING_ACTION"))]);(a=L("PREVIOUS_ACTION"))&&
D(b,13,W[Lt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=Zr())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=bu();1!==a&&-1!==a||D(b,6,!0);a=tt();M("skip_setting_info_in_csi_data_object")&&ut();D(b,3,"cold");cu(a);a=du();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Hj,D(d,1,c),de(b,83,Hj,d);au(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&eu(b,a[b]);b={isNavigation:!0,actionType:Lt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=
Lt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=L("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=Zr())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=bu();if(1===a||-1===a)b.isVisible=!0;M("skip_setting_info_in_csi_data_object")&&ut();tt();b.loadType="cold";cu(tt());a=du();if(0<a.length)for(b.resourceInfo=[],a=p(a),c=a.next();!c.done;c=a.next())b.resourceInfo.push({resourceCache:c.value});fu(b)}b=tt();a=xt();if(!(M("skip_setting_info_in_csi_data_object")&&"cold"!==ut().loadType||"cold"!==b.yt_lt&&
"cold"!==a.loadType)){c=vt();d=wt();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var f in c)if(!(f in d))if("number"===typeof c[f])Z(f,ot(f));else if(M("log_repeated_ytcsi_ticks")){e=p(c[f]);for(var g=e.next();!g.done;g=e.next())Z(f.slice(1),g.value)}f={};c=!1;d=p(Object.keys(b));for(e=d.next();!e.done;e=d.next())e=e.value,(e=Mt(e,b[e]))&&!Bt(xt(),e)&&(bt(a,e),bt(f,e),c=!0);c&&fu(f)}A("ytglobal.timingready_",!0);f=L("TIMING_ACTION");B("ytglobal.timingready_")&&f&&"_start"in vt()&&nt()&&At()}
function eu(a,b,c,d){if(null!==b){var e=tt(c);M("skip_setting_info_in_csi_data_object")?"yt_lt"===a&&(e="string"===typeof b?b:""+b,ut(c).loadType=e):e[a]=b;(a=Mt(a,b,c))&&fu(a,c,d)}}
function fu(a,b,c){if(!M("web_csi_via_jspb")||(void 0===c?0:c))c=Et(b||""),bt(c.info,a),M("skip_setting_info_in_csi_data_object")&&a.loadType&&(c=a.loadType,ut(b).loadType=c),bt(xt(b),a),c=zt(b),b=st(b).cttAuthInfo,Yt().info(a,c,b);else{c=new Ij;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":D(c,1,W[a[e]]);break;case "clientActionNonce":D(c,2,a[e]);break;case "clientScreenNonce":D(c,4,a[e]);break;case "loadType":D(c,3,a[e]);break;case "isPrewarmedLaunch":D(c,
92,a[e]);break;case "isFirstInstall":D(c,55,a[e]);break;case "networkType":D(c,5,Nt[a[e]]);break;case "connectionType":D(c,26,X[a[e]]);break;case "detailedConnectionType":D(c,27,Y[a[e]]);break;case "isVisible":D(c,6,a[e]);break;case "playerType":D(c,7,Ot[a[e]]);break;case "clientPlaybackNonce":D(c,8,a[e]);break;case "adClientPlaybackNonce":D(c,28,a[e]);break;case "previousCpn":D(c,77,a[e]);break;case "targetCpn":D(c,76,a[e]);break;case "isMonetized":D(c,9,a[e]);break;case "isPrerollAllowed":D(c,16,
a[e]);break;case "isPrerollShown":D(c,17,a[e]);break;case "adType":D(c,12,a[e]);break;case "adTypesAllowed":D(c,36,a[e]);break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,W[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,Pt[a[e]]);break;case "isNavigation":D(c,25,a[e]);break;case "viewportHeight":D(c,
...
64,a[e]);break;case "shellStartupDurationMs":D(c,70,a[e]);break;case "appInstallDataAgeMs":D(c,73,a[e]);break;case "latencyActionError":D(c,71,Qt[a[e]]);break;case "actionStep":D(c,79,a[e]);break;case "jsHeapSizeLimit":D(c,80,a[e]);break;case "totalJsHeapSize":D(c,81,a[e]);break;case "usedJsHeapSize":D(c,82,a[e]);break;case "sourceVideoDurationMs":D(c,90,a[e]);break;case "videoOutputFrames":D(c,93,a[e]);break;case "isResume":D(c,104,a[e]);break;case "adPrebufferedTimeSecs":D(c,39,a[e]);break;case "isLivestream":D(c,
47,a[e]);break;case "liveStreamMode":D(c,91,Rt[a[e]]);break;case "adCpn2":D(c,48,a[e]);break;case "adDaiDriftMillis":D(c,49,a[e]);break;case "videoStreamType":D(c,53,St[a[e]]);break;case "playbackRequiresTap":D(c,56,a[e]);break;case "performanceNavigationTiming":D(c,67,a[e]);break;case "transactionType":D(c,74,Tt[a[e]]);break;case "playerRotationType":D(c,101,Ut[a[e]]);break;case "allowedPreroll":D(c,10,a[e]);break;case "shownPreroll":D(c,11,a[e]);break;case "getHomeRequestId":D(c,57,a[e]);break;
case "getSearchRequestId":D(c,60,a[e]);break;case "getPlayerRequestId":D(c,61,a[e]);break;case "getWatchNextRequestId":D(c,62,a[e]);break;case "getBrowseRequestId":D(c,63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:Vt.includes(f)&&Kk(new P("Codegen laipb translator asked to translate message field",""+f))}}catch(g){Kk(Error("Codegen laipb translator failed to set "+f))}}au(c,b)}}
function au(a,b){if(M("skip_setting_info_in_csi_data_object")){var c=fe(Ud(a,3),"");c&&(ut(b).loadType=c)}else c=wt(b),c.jspbInfos||(c.jspbInfos=[]),c.jspbInfos.push(ie(a));Et(b||"").jspbInfo.push(a);c=zt(b);b=st(b).cttAuthInfo;Yt().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}d=Et(c||"");d.tick[a]=b||R();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=wt(c);d.gelTicks&&(d.gelTicks[a]=!0);e=vt(c);d=b||R();M("log_repeated_ytcsi_ticks")?a in e||(e[a]=d):e[a]=d;e=zt(c);var f=st(c).cttAuthInfo;"_start"===a?(a=Yt(),Zt(a,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(a=new Gj,
D(a,1,e),e=new jk,be(e,Gj,6,kk,a),gr(e,b)):cm("latencyActionBaselined",{clientActionNonce:e},b))):Yt().tick(a,e,b,f);At(c);return d}
function gu(){var a=zt();requestAnimationFrame(function(){setTimeout(function(){a===zt()&&Z("ol",void 0,void 0)},0)})}
function bu(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=Op+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function cu(a){var b=pt(),c=rt(),d=L("CSI_START_TIMESTAMP_MILLIS",0);0<d&&!M("embeds_web_enable_csi_start_override_killswitch")&&(c=d);c&&(Z("srt",b.responseStart),1!==a.prerender&&Z("_start",c,void 0));a=Ct();0<a&&Z("fpt",a);a=pt();a.isPerformanceNavigationTiming&&fu({performanceNavigationTiming:!0});Z("nreqs",a.requestStart,void 0);Z("nress",a.responseStart,void 0);Z("nrese",a.responseEnd,void 0);0<a.redirectEnd-a.redirectStart&&(Z("nrs",a.redirectStart,void 0),Z("nre",a.redirectEnd,void 0));0<
a.domainLookupEnd-a.domainLookupStart&&(Z("ndnss",a.domainLookupStart,void 0),Z("ndnse",a.domainLookupEnd,void 0));0<a.connectEnd-a.connectStart&&(Z("ntcps",a.connectStart,void 0),Z("ntcpe",a.connectEnd,void 0));a.secureConnectionStart>=rt()&&0<a.connectEnd-a.secureConnectionStart&&(Z("nstcps",a.secureConnectionStart,void 0),Z("ntcpe",a.connectEnd,void 0));S&&"getEntriesByType"in S&&hu()}
function iu(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);ic()&&a.setAttribute("nonce",ic());return c?(a=S.getEntriesByName(c))&&a[0]&&(a=a[0],c=rt(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function du(){var a=[];if(document.querySelector&&S&&S.getEntriesByName)for(var b in mt)if(mt.hasOwnProperty(b)){var c=mt[b];iu(b,c)&&a.push(c)}return a}
function hu(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=gb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
(b=ib(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",qt(b.startTime)),Z("wffe",qt(b.responseEnd)))}
var ju=window;ju.ytcsi&&(ju.ytcsi.info=eu,ju.ytcsi.tick=Z);var ku="tokens consistency mss client_location entities response_received_commands store PLAYER_PRELOAD".split(" "),lu=["type.googleapis.com/youtube.api.pfiinnertube.YoutubeApiInnertube.BrowseResponse"];function mu(a,b,c,d){this.o=a;this.M=b;this.m=c;this.l=d;this.j=void 0;this.i=new Map;a.Pa||(a.Pa={});a.Pa=Object.assign({},at,a.Pa)}
function nu(a,b,c,d){if(void 0!==mu.i){if(d=mu.i,a=[a!==d.o,b!==d.M,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new P("InnerTubeTransportService is already initialized",a);
}else mu.i=new mu(a,b,c,d)}
function ou(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Bs:c;var d=Ks(b,a.o);if(!d)return Df(new P("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new yf(function(f){var g,h,k;return x(function(m){if(1==m.i){h="cors"===(null==(g=e.za)?void 0:g.mode)?"cors":void 0;if(a.m.vd){var q=e.config,r;q=null==q?void 0:null==(r=q.Ya)?void 0:r.sessionIndex;r=As({sessionIndex:q});k=Object.assign({},pu(h),r);return m.B(2)}return v(m,qu(e.config,
h),3)}2!=m.i&&(k=m.j);f(ru(a,e,k));m.i=0})}):Df(new P("Error: Failed to build request for command.",b))}
function su(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.yr)?0:d.Br)&&a.l){d=p(ku);for(var e=d.next();!e.done;e=d.next())e=e.value,a.l[e]&&a.l[e].handleResponse(b,c)}}
function ru(a,b,c){var d,e,f,g,h,k,m,q,r,w,t,y,E,F,O,N,Q,ca,U,mb,Xa,na,H,la,fa,ve,we,pd;return x(function(pa){switch(pa.i){case 1:pa.B(2);break;case 3:if((d=pa.j)&&!d.isExpired())return pa.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ia)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.ur(b.ia.context);if(null==(m=a.j)||!m.zr(b.input,b.ia)){pa.B(4);break}return v(pa,a.j.qr(b.input,b.ia),5);case 5:return q=pa.j,M("kevlar_process_local_innertube_responses_killswitch")||
su(a,q,b),pa.return(q);case 4:return(t=null==(w=b.config)?void 0:w.Fa)&&a.i.has(t)&&M("web_memoize_inflight_requests")?r=a.i.get(t):(y=JSON.stringify(b.ia),O=null!=(F=null==(E=b.za)?void 0:E.headers)?F:{},b.za=Object.assign({},b.za,{headers:Object.assign({},O,c)}),N=Object.assign({},b.za),"POST"===b.za.method&&(N=Object.assign({},N,{body:y})),(null==(Q=b.config)?0:Q.hd)&&Z(b.config.hd),ca=function(){return a.M.fetch(b.input,N,b.config)},r=ca(),t&&a.i.set(t,r)),v(pa,r,6);
case 6:U=pa.j;if(M("web_one_platform_error_handling")&&U&&"error"in U&&(null==(mb=U)?0:null==(Xa=mb.error)?0:Xa.details))for(na=U.error.details,H=p(na),la=H.next();!la.done;la=H.next())fa=la.value,(ve=fa["@type"])&&-1<lu.indexOf(ve)&&(delete fa["@type"],U=fa);t&&a.i.has(t)&&a.i.delete(t);(null==(we=b.config)?0:we.jd)&&Z(b.config.jd);if(U||null==(pd=a.j)||!pd.hr(b.input,b.ia)){pa.B(7);break}return v(pa,a.j.pr(b.input,b.ia),8);case 8:U=pa.j;case 7:return su(a,U,b),pa.return(U||void 0)}})}
function qu(a,b){var c,d,e,f;return x(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ya)?void 0:d.sessionIndex;var h=As({sessionIndex:e});if(!(h instanceof yf)){var k=new yf(cb);zf(k,2,h);h=k}return v(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},pu(b),f)))})}
function pu(a){var b={"Content-Type":"application/json"};L("EOM_VISITOR_DATA")?b["X-Goog-EOM-Visitor-Id"]=L("EOM_VISITOR_DATA"):L("VISITOR_DATA")&&(b["X-Goog-Visitor-Id"]=L("VISITOR_DATA"));M("track_webfe_innertube_auth_mismatch")&&(b["X-Youtube-Bootstrap-Logged-In"]=L("LOGGED_IN",!1));"cors"!==a&&((a=L("INNERTUBE_CONTEXT_CLIENT_NAME"))&&(b["X-Youtube-Client-Name"]=a),(a=L("INNERTUBE_CONTEXT_CLIENT_VERSION"))&&(b["X-Youtube-Client-Version"]=a),(a=L("CHROME_CONNECTED_HEADER"))&&(b["X-Youtube-Chrome-Connected"]=
a),(a=L("DOMAIN_ADMIN_STATE"))&&(b["X-Youtube-Domain-Admin-State"]=a));return b}
;var tu=new Ms("INNERTUBE_TRANSPORT_TOKEN");var uu=["share/get_web_player_share_panel"],vu=["feedback"],wu=["notification/modify_channel_preference"],xu=["browse/edit_playlist"],yu=["subscription/subscribe"],zu=["subscription/unsubscribe"];function Au(){}
u(Au,Ys);Au.prototype.l=function(){return yu};
Au.prototype.i=function(a){return ms(a,vk)||void 0};
Au.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params);c.botguardResponse&&(a.botguardResponse=c.botguardResponse);c.feature&&(a.clientFeature=c.feature)};
ea.Object.defineProperties(Au.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Bu(){}
u(Bu,Ys);Bu.prototype.l=function(){return zu};
Bu.prototype.i=function(a){return ms(a,uk)||void 0};
Bu.prototype.j=function(a,b){b.channelIds&&(a.channelIds=b.channelIds);b.siloName&&(a.siloName=b.siloName);b.params&&(a.params=b.params)};
ea.Object.defineProperties(Bu.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Cu(){}
u(Cu,Ys);Cu.prototype.l=function(){return vu};
Cu.prototype.i=function(a){return ms(a,ej)||void 0};
Cu.prototype.j=function(a,b,c){a.feedbackTokens=[];b.feedbackToken&&a.feedbackTokens.push(b.feedbackToken);if(b=b.cpn||c.cpn)a.feedbackContext={cpn:b};a.isFeedbackTokenUnencrypted=!!c.is_feedback_token_unencrypted;a.shouldMerge=!1;c.extra_feedback_tokens&&(a.shouldMerge=!0,a.feedbackTokens=a.feedbackTokens.concat(c.extra_feedback_tokens))};
ea.Object.defineProperties(Cu.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!0}}});function Du(){}
u(Du,Ys);Du.prototype.l=function(){return wu};
Du.prototype.i=function(a){return ms(a,tk)||void 0};
Du.prototype.j=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function Eu(){}
u(Eu,Ys);Eu.prototype.l=function(){return xu};
Eu.prototype.i=function(a){return ms(a,sk)||void 0};
Eu.prototype.j=function(a,b){b.actions&&(a.actions=b.actions);b.params&&(a.params=b.params);b.playlistId&&(a.playlistId=b.playlistId)};function Fu(){}
u(Fu,Ys);Fu.prototype.l=function(){return uu};
Fu.prototype.i=function(a){return ms(a,rk)};
Fu.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Os=new Ms("NETWORK_SLI_TOKEN");function Gu(a){this.i=a}
Gu.prototype.fetch=function(a,b){var c=this,d,e;return x(function(f){c.i&&(d=mc(nc(5,Dc(a,"key")))||"/UNKNOWN_PATH",c.i.start(d));e=new window.Request(a,b);return M("web_fetch_promise_cleanup_killswitch")?f.return(Promise.resolve(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Hr(g)}))):f.return(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Hr(g)}))})};
Gu.prototype.handleResponse=function(a){var b=a.text().then(function(c){return JSON.parse(c.replace(")]}'",""))});
a.redirected||a.ok?this.i&&this.i.success():(this.i&&this.i.failure(),b=b.then(function(c){Hr(new P("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
Gu[Ls]=[new Ns];var Hu=new Ms("NETWORK_MANAGER_TOKEN");var Iu;function Ju(a){co.call(this,1,arguments);this.csn=a}
u(Ju,co);var mo=new eo("screen-created",Ju),Ku=[],Mu=Lu,Nu=0;function Ou(a,b,c,d,e,f,g){function h(){Hr(new P("newScreen() parent element does not have a VE - rootVe",b))}
var k=Mu(),m=new Sr({veType:b,youtubeData:f,jspbYoutubeData:void 0});f={ba:k};e&&(f.cttAuthInfo=e);M("il_via_jspb")?(e=new vj,e.j(k),wj(e,m.getAsJspb()),c&&c.visualElement?(m=new xj,c.clientScreenNonce&&D(m,2,c.clientScreenNonce),yj(m,c.visualElement.getAsJspb()),g&&D(m,4,lk[g]),G(e,xj,5,m)):c&&h(),d&&D(e,3,d),lr(e,f,a)):(e={csn:k,pageVe:m.getAsJson()},c&&c.visualElement?(e.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(e.implicitGesture.gestureType=g)):
c&&h(),d&&(e.cloneCsn=d),a?br("screenCreated",e,a,f):cm("screenCreated",e,f));jo(mo,new Ju(k));return k}
function Pu(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:as(b)||void 0,
ba:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&Hr(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new zj;h.j(b);Bj(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();de(h,3,tj,k)});
"UNDEFINED_CSN"===b?Qu("visualElementAttached",f,void 0,h):mr(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:hb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"===b?Qu("visualElementAttached",f,c):a?br("visualElementAttached",c,a,f):cm("visualElementAttached",c,f)}
function Lu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return ed(b,3)}
function Qu(a,b,c,d){Ku.push({payloadName:a,payload:c,xa:d,options:b});Nu||(Nu=no())}
function oo(a){if(Ku){for(var b=p(Ku),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.xa.j(a.csn),c.payloadName){case "screenCreated":lr(c.xa,c.options);break;case "visualElementAttached":mr(c.xa,c.options);break;case "visualElementShown":hr(c.xa,c.options);break;case "visualElementHidden":ir(c.xa,c.options);break;case "visualElementGestured":jr(c.xa,c.options);break;case "visualElementStateChanged":kr(c.xa,c.options);break;default:Hr(new P("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,br(c.payloadName,c.payload,null,c.options);Ku.length=0}Nu=0}
;function Ru(){this.l=new Set;this.i=new Set;this.m=new Map;this.client=Mp;this.csn=null}
function Su(){Ru.i||(Ru.i=new Ru);return Ru.i}
Ru.prototype.j=function(a){this.client=a};
Ru.prototype.clear=function(){this.l.clear();this.i.clear();this.m.clear();this.csn=null};function Tu(){this.l=new Set;this.i=new Set;this.m=new Map}
Tu.prototype.j=function(a){M("use_ts_visibilitylogger")&&Su().j(a)};
Tu.prototype.clear=function(){M("use_ts_visibilitylogger")?Su().clear():(this.l.clear(),this.i.clear(),this.m.clear())};
Na(Tu);function Uu(){this.s=[];this.N=[];this.i=[];this.o=[];this.C=[];this.l=new Set;this.u=new Map}
Uu.prototype.j=function(a){this.client=a};
function Vu(a,b,c){c=void 0===c?0:c;b.then(function(d){a.l.has(c)&&a.m&&a.m();var e=Zr(c),f=Xr(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&Pu(a.client,e,f,[Tr(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&Pu(a.client,e,f,[Tr(d.playerResponse.trackingParams)])}})}
function Wu(a,b,c,d){d=void 0===d?0:d;if(a.l.has(d))a.s.push([b,c]);else{var e=Zr(d);c=c||Xr(d);e&&c&&Pu(a.client,e,c,[b])}}
Uu.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Zr(void 0===c?0:c)){a=this.client;var e=Tr(d);d={cttAuthInfo:as(c)||void 0,ba:c};M("il_via_jspb")?(b=new Cj,b.j(c),e=e.getAsJspb(),G(b,tj,2,e),D(b,4,lk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK),"UNDEFINED_CSN"===c?Qu("visualElementGestured",d,void 0,b):jr(b,d,a)):(e={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(e.clientData=b),"UNDEFINED_CSN"===c?Qu("visualElementGestured",
d,e):a?br("visualElementGestured",e,a,d):cm("visualElementGestured",e,d));b=!0}else b=!1;else b=!1;return b};
function Xu(a,b,c){c=void 0===c?{}:c;a.l.add(c.layer||0);a.m=function(){Yu(a,b,c);var f=Xr(c.layer);if(f){for(var g=p(a.s),h=g.next();!h.done;h=g.next())h=h.value,Wu(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Zr(g);var m=k[0]||Xr(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:as(h)||void 0,ba:h};M("il_via_jspb")?(q=new Fj,q.j(h),m=m.getAsJspb(),G(q,tj,2,m),"UNDEFINED_CSN"===h?Qu("visualElementStateChanged",k,void 0,q):kr(q,k,g)):
(m={csn:h,ve:m.getAsJson(),clientData:q},"UNDEFINED_CSN"===h?Qu("visualElementStateChanged",k,m):g?br("visualElementStateChanged",m,g,k):cm("visualElementStateChanged",m,k))}}}};
Zr(c.layer)||a.m();if(c.Yb)for(var d=p(c.Yb),e=d.next();!e.done;e=d.next())Vu(a,e.value,c.layer);else Gr(Error("Delayed screen needs a data promise."))}
function Yu(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.cd?c.cd:c.layer;var e=Zr(d);d=Xr(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Ou(a.client,b,f,c.Xb,c.cttAuthInfo,g,c.lr)}catch(m){Jr(m,{wr:b,rootVe:d,parentVisualElement:void 0,ir:e,tr:f,Xb:c.Xb});Gr(m);return}bs(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Rr));for(f=b.next();!f.done;f=b.next())if(Zr(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:as(e)||void 0,ba:e,Zb:g},M("il_via_jspb")?(h=new Dj,h.j(e),d=d.getAsJspb(),G(h,tj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"===e?Qu("visualElementHidden",f,void 0,h):ir(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"===e?Qu("visualElementHidden",f,d):b?br("visualElementHidden",
d,b,f):cm("visualElementHidden",d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");fu({clientScreenNonce:k});d=Tu.getInstance();M("use_ts_visibilitylogger")?(d=Su(),d.clear(),d.csn=Zr()):d.clear();d=Xr(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:as(e)||void 0,ba:e},M("il_via_jspb")?(b=new Ej,b.j(e),f=d.getAsJspb(),G(b,tj,2,f),D(b,4,1),"UNDEFINED_CSN"===e?Qu("visualElementShown",k,void 0,b):hr(b,
k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"===e?Qu("visualElementShown",k,b):cm("visualElementShown",b,k)));a.l.delete(c.layer||0);a.m=void 0;e=p(a.u);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Wu(a,k,d,c.layer);for(c=0;c<a.o.length;c++){e=a.o[c];try{e()}catch(m){Gr(m)}}for(c=a.o.length=0;c<a.C.length;c++){e=a.C[c];try{e()}catch(m){Gr(m)}}}
;function Zu(){var a,b,c;return x(function(d){if(1==d.i)return a=Ts().resolve(tu),a?v(d,ou(a),2):(Hr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),d.return(void 0));if(b=d.j){if(b.errorMetadata)return Hr(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),d.return(void 0);c=b.jr;return d.return(c)}Hr(Error("Network request to get Datasync IDs failed."));return d.return(void 0)})}
;var $u=z.caches,av;function bv(a){var b=a.indexOf(":");return-1===b?{mc:a}:{mc:a.substring(0,b),datasyncId:a.substring(b+1)}}
function cv(){return x(function(a){if(void 0!==av)return a.return(av);av=new Promise(function(b){var c;return x(function(d){switch(d.i){case 1:return ya(d,2),v(d,$u.open("test-only"),4);case 4:return v(d,$u.delete("test-only"),5);case 5:za(d,3);break;case 2:if(c=Aa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(av)})}
function dv(a){var b,c,d,e,f,g,h;x(function(k){if(1==k.i)return v(k,cv(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return v(k,$u.keys(),3)}c=k.j;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=bv(f),h=g.datasyncId,!h||a.includes(h)||b.push($u.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function ev(){var a,b,c,d,e,f,g;return x(function(h){if(1==h.i)return v(h,cv(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=Rl("cache contains other");return v(h,$u.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=bv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function fv(){try{return!!self.localStorage}catch(a){return!1}}
;function gv(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function hv(a){if(fv()){var b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=gv(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function iv(){if(!fv())return!1;var a=Rl(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=gv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function jv(){Zu().then(function(a){a&&(pn(a),dv(a),hv(a))})}
function kv(){var a=new Qo;Xh.V(function(){var b,c,d,e;return x(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.B(2);break}b=Rl("clear");if(b.startsWith("V")){var g=[b];pn(g);dv(g);hv(g);return f.return()}c=iv();return v(f,ev(),3);case 3:return d=f.j,v(f,qn(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.W()?jv():a.m.add("publicytnetworkstatus-online",jv,!0,void 0,void 0),f.i=0}})})}
;function lv(a){a&&(a.dataset?a.dataset[mv("loaded")]="true":a.setAttribute("data-loaded","true"))}
...
function sv(a,b,c){c=void 0===c?null:c;var d=tv(a),e=document.getElementById(d),f=e&&nv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=hq(d,b),b=""+Ra(b),uv[b]=f),g||(e=vv(a,d,function(){nv(e,"loaded")||(lv(e),kq(d),dl(Ya(lq,d),0))},c)))}
function vv(a,b,c,d){d=void 0===d?null:d;var e=lf("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function wv(a){a=tv(a);var b=document.getElementById(a);b&&(lq(a),b.parentNode.removeChild(b))}
function xv(a,b){a&&b&&(a=""+Ra(b),(a=uv[a])&&jq(a))}
function tv(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var uv={};var yv=[],zv=!1;function Av(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&os()){var a=L("PLAYER_VARS",{});if("1"!=tb(a)&&!ps(a)){var b=function(){zv=!0;"google_ad_status"in window?Bk("DCLKSTAT",1):Bk("DCLKSTAT",2)};
try{rv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}yv.push(Xh.V(function(){if(!(zv||"google_ad_status"in window)){try{xv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}zv=!0;Bk("DCLKSTAT",3)}},5E3))}}}
function Bv(){var a=Number(L("DCLKSTAT",0));return isNaN(a)?0:a}
;function Cv(){this.state=1;this.i=null}
l=Cv.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Db("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=Ab())?f.createScript(e):e,e=(new Hb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Db("From proto message. b/166824318"),d=Lb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());Fv(this,e,
d,a.program,b,c)}else Hr(Error("Cannot initialize botguard without program"))};
...
function Gv(a,b,c,d){a.state=5;try{var e=new Ch({program:b,globalName:c,fd:M("att_web_record_metrics")});e.sd.then(function(){a.state=6;d&&d(b)});
a.Jb(e)}catch(f){a.state=7,f instanceof Error&&Hr(f)}}
l.invoke=function(a){a=void 0===a?{}:a;var b=this.yb();if(b){var c={Wb:a};if(b.eb)throw Error("Already disposed");a=Ah();var d;null!=(d=b.wa)&&d.j.i.Lb("/client_streamz/bg/fsc",d.Fa);d=b.wd([c.Wb,c.ud]);null!=(b=b.wa)&&(a=Ah()-a,b.l.i.ob("/client_streamz/bg/fsl",a,b.Fa));b=d}else b=null;return b};
l.dispose=function(){this.Mb()};
l.Mb=function(){this.Jb(null);this.state=8};
l.yb=function(){return this.i};
l.Jb=function(a){qe(this.i);this.i=a};function Hv(){Cv.apply(this,arguments)}
u(Hv,Cv);Hv.prototype.Mb=function(){this.state=8};
Hv.prototype.yb=function(){return B("yt.abuse.playerAttLoader")};
Hv.prototype.Jb=function(a){qe(B("yt.abuse.playerAttLoader"));A("yt.abuse.playerAttLoader",a);a&&A("yt.abuse.playerAttLoaderRun",function(b){return a.snapshot(b)})};var Iv=new Hv;var Jv=new Cv;function Kv(){return M("use_player_abuse_bg_library")?Iv.isInitialized():Jv.isInitialized()}
function Lv(a){a=void 0===a?{}:a;M("use_player_abuse_bg_library")?(a=void 0===a?{}:a,a=Iv.invoke(a)):a=Jv.invoke(a);return a}
...
e=Ll(d,Nv(this,a.Ha));this.i[a.Ra]=Object.assign({},a.Ha,{Bb:d,jobId:e})}}
function Ov(a){var b=Array.from(a.i.keys()).sort(function(d,e){return Nv(a,a.i[e])-Nv(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.jobId||c.kb||(a.l.ga(c.jobId),Ll(c.Bb,10))}
Mv.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.jobId||b.kb||this.l.ga(b.jobId),b.kb=!0;this.j.resolve()};
function Nv(a,b){var c;return null!=(c=b.priority)?c:a.m}
;function Pv(a){this.state=a;this.plugins=[];this.s=void 0}
Pv.prototype.install=function(){this.plugins.push.apply(this.plugins,ia(Ja.apply(0,arguments)))};
Pv.prototype.uninstall=function(){var a=this;Ja.apply(0,arguments).forEach(function(b){b=a.plugins.indexOf(b);-1<b&&a.plugins.splice(b,1)})};
Pv.prototype.transition=function(a,b){var c=this,d=this.C.find(function(f){return Array.isArray(f.from)?f.from.find(function(g){return g===c.state&&f.F===a}):f.from===c.state&&f.F===a});
if(d){this.l&&(Ov(this.l),this.l=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(Qv(this,e,this.s),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function Qv(a,b,c){return function(){var d=Ja.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
u(Sv,Pv);Sv.prototype.j=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_foregrounded")};
Sv.prototype.i=function(a,b){a(null==b?void 0:b.event);M("visibility_lifecycles_dynamic_backgrounding")&&this.transition("document_backgrounded")};
Sv.prototype.m=function(a,b){a(null==b?void 0:b.event)};
Sv.prototype.o=function(a,b){a(null==b?void 0:b.event)};function Tv(){this.i=new Rv;this.j=new Sv}
Tv.prototype.install=function(){var a=Ja.apply(0,arguments);this.i.install.apply(this.i,ia(a));this.j.install.apply(this.j,ia(a))};function Uv(){Tv.call(this);var a={};this.install((a.document_disposed={callback:this.l},a));a={};this.install((a.flush_logs={callback:this.m},a))}
var Vv;u(Uv,Tv);Uv.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new sj,b=Zr();b&&D(a,1,b);b=new jk;be(b,sj,380,kk,a);gr(b);M("web_fp_via_jspb_and_json")&&cm("finalPayload",{csn:Zr()})}else cm("finalPayload",{csn:Zr()})};
Uv.prototype.l=function(){Lr(Mr)};function Wv(){}
Wv.getInstance=function(){var a=B("ytglobal.storage_");a||(a=new Wv,A("ytglobal.storage_",a));return a};
Wv.prototype.estimate=function(){var a,b,c;return x(function(d){a=navigator;return(null==(b=a.storage)?0:b.estimate)?d.return(a.storage.estimate()):(null==(c=a.webkitTemporaryStorage)?0:c.queryUsageAndQuota)?d.return(Xv()):d.return()})};
...
A("ytglobal.storageClass_",Wv);function am(a,b){var c=this;this.handleError=a;this.i=b;this.j=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.j=!0});
...
function Yv(a,b){Wv.getInstance().estimate().then(function(c){c=Object.assign({},b,{isSw:void 0===self.document,isIframe:self!==self.top,deviceStorageUsageMbytes:Zv(null==c?void 0:c.usage),deviceStorageQuotaMbytes:Zv(null==c?void 0:c.quota)});a.i("idbQuotaExceeded",c)})}
function Zv(a){return"undefined"===typeof a?"-1":String(Math.ceil(a/1048576))}
;function $v(a,b,c){J.call(this);var d=this;c=c||L("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.targetOrigin="*";this.m=c;this.sessionId=null;this.channel="widget";this.H=!!a;this.u=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.H&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
u($v,J);$v.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){Lk(d)}}};
$v.prototype.D=function(){window.removeEventListener("message",this.u);J.prototype.D.call(this)};function aw(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new $v(!!L("WIDGET_ID_ENFORCE")),b=this.ed.bind(this);a.o=b;a.s=null;this.i.channel="widget";if(a=L("WIDGET_ID"))this.i.sessionId=a}
l=aw.prototype;l.ed=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,bw(this,a)),this.l[a]=!0)):this.Nb(a,b,c)};
l.Nb=function(){};
function bw(a,b){return function(c){return a.sendMessage(b,c)}}
l.addEventListener=function(){};
l.Rc=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.wb());this.sendMessage("onReady");fb(this.j,this.uc,this);this.j=[]};
...
function iw(a,b,c,d){if(Qa(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function jw(a){aw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.pd.bind(this));this.addEventListener("onVolumeChange",this.qd.bind(this));this.addEventListener("onApiChange",this.kd.bind(this));this.addEventListener("onPlaybackQualityChange",this.md.bind(this));this.addEventListener("onPlaybackRateChange",this.nd.bind(this));this.addEventListener("onStateChange",this.od.bind(this));this.addEventListener("onWebglSettingsChanged",
this.rd.bind(this))}
u(jw,aw);l=jw.prototype;
l.Nb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&gw(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=hw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=hw(e);break;case "loadPlaylist":case "cuePlaylist":e=iw(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);gw(a)&&cw(this,this.wb())}};
l.onReady=function(){var a=this.Rc.bind(this);this.i.j=a;a=this.api.getVideoData();if(!a.isPlayable){a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?ew[a]||b:b).toString())}};
...
l.md=function(a){cw(this,{playbackQuality:a})};
l.nd=function(a){cw(this,{playbackRate:a})};
...
l.qd=function(){cw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
l.rd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};cw(this,a)};
l.dispose=function(){aw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function kw(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.oc,this)}
u(kw,J);l=kw.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.Aa("RECEIVING"))};
l.Aa=function(a,b){this.started&&!this.i()&&this.connection.Aa(a,b)};
l.oc=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=lw(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=mw(a,c))&&this.Aa(a,c))}}};
l.addListener=function(a){if(!(a in this.j)){var b=this.ld.bind(this,a);this.j[a]=b;this.addEventListener(a,b)}};
l.ld=function(a,b){this.started&&!this.i()&&this.connection.Aa(a,this.vb(a,b))};
...
l.D=function(){var a=this.connection;a.i()||ti(a.j,"command",this.oc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function nw(a,b){kw.call(this,b);this.api=a;this.start()}
...
nw.prototype.vb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return kw.prototype.vb.call(this,a,b)};
nw.prototype.D=function(){kw.prototype.D.call(this);delete this.api};function ow(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);se(this,this.j)}
Za(ow,J);ow.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
ow.prototype.m=function(a,b){this.i()||this.j.ta.apply(this.j,arguments)};function pw(a,b,c){ow.call(this);this.l=a;this.destination=b;this.id=c}
u(pw,ow);pw.prototype.Aa=function(a,b){this.i()||this.l.Aa(this.destination,this.id,a,b)};
pw.prototype.D=function(){this.destination=this.l=null;ow.prototype.D.call(this)};function qw(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=Vp(window,"message",this.l.bind(this));this.connection=new pw(this,a,b);se(this,this.connection)}
u(qw,J);qw.prototype.Aa=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(JSON.stringify(a),this.origin))};
qw.prototype.l=function(a){if(!this.i()&&a.origin===this.origin){var b=a.data;if("string"===typeof b){try{b=JSON.parse(b)}catch(d){return}if(b.command){var c=this.connection;c.i()||c.m("command",b.command,b.data,a.origin)}}}};
qw.prototype.D=function(){Wp(this.j);this.destination=null;J.prototype.D.call(this)};function rw(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||vb(b);this.assets=a.assets||{};this.attrs=a.attrs||vb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
rw.prototype.clone=function(){var a=new rw,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Oa(c)?a[b]=vb(c):a[b]=c}return a};var sw=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function tw(a){a=a||"";if(window.spf){var b=a.match(sw);spf.style.load(a,b?b[1]:"",void 0)}else uw(a)}
function uw(a){var b=vw(a),c=document.getElementById(b),d=c&&nv(c,"loaded");d||c&&!d||(c=ww(a,b,function(){nv(c,"loaded")||(lv(c),kq(b),dl(Ya(lq,b),0))}))}
function ww(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Lb(a);gc(d,a);(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function vw(a){var b=lf("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
;function xw(){J.call(this);this.j=[]}
u(xw,J);xw.prototype.D=function(){for(;this.j.length;){var a=this.j.pop();a.target.removeEventListener(a.name,a.callback,void 0)}J.prototype.D.call(this)};function yw(){xw.apply(this,arguments)}
u(yw,xw);function zw(a,b,c,d){J.call(this);var e=this;this.u=b;this.webPlayerContextConfig=d;this.ea=!1;this.api={};this.X=this.s=null;this.L=new K;this.j={};this.R=this.Y=this.elementId=this.va=this.config=null;this.P=!1;this.m=this.H=null;this.la={};this.Wa=["onReady"];this.lastError=null;this.Ja=NaN;this.K={};this.Xa=new yw(this);this.T=0;this.l=this.o=a;se(this,this.L);Aw(this);Bw(this);se(this,this.Xa);c?this.T=dl(function(){e.loadNewVideoConfig(c)},0):d&&(Cw(this),Dw(this))}
u(zw,J);l=zw.prototype;l.getId=function(){return this.u};
l.loadNewVideoConfig=function(a){if(!this.i()){this.T&&(window.clearTimeout(this.T),this.T=0);var b=a||{};b instanceof rw||(b=new rw(b));this.config=b;this.setConfig(a);Dw(this);this.isReady()&&Ew(this)}};
function Cw(a){var b;a.webPlayerContextConfig?b=a.webPlayerContextConfig.rootElementId:b=a.config.attrs.id;a.elementId=b||a.elementId;"video-player"===a.elementId&&(a.elementId=a.u,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.u:a.config.attrs.id=a.u);var c;(null==(c=a.l)?void 0:c.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){this.va=a;this.config=Fw(a);Cw(this);if(!this.Y){var b;this.Y=Gw(this,(null==(b=this.config.args)?void 0:b.jsapicallback)||"onYouTubePlayerReady")}this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null==(c=this.config)?0:c.attrs)a=this.config.attrs,(b=a.width)&&this.l&&(this.l.style.width=Qh(Number(b)||b)),(a=a.height)&&this.l&&(this.l.style.height=Qh(Number(a)||a))};
function Ew(a){if(a.config&&!0!==a.config.loaded)if(a.config.loaded=!0,!a.config.args||"0"!==a.config.args.autoplay&&0!==a.config.args.autoplay&&!1!==a.config.args.autoplay){var b;a.api.loadVideoByPlayerVars(null!=(b=a.config.args)?b:null)}else a.api.cueVideoByPlayerVars(a.config.args)}
function Hw(a){var b=!0,c=Iw(a);c&&a.config&&(a=Jw(a),b=nv(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function Dw(a){if(!a.i()&&!a.P){var b=Hw(a);if(b&&"html5"===(Iw(a)?"html5":null))a.R="html5",a.isReady()||Kw(a);else if(Lw(a),a.R="html5",b&&a.m&&a.o)a.o.appendChild(a.m),Kw(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.H=function(){c=!0;var d=Mw(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Fw(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);Kw(a)};
a.P=!0;b?a.H():(rv(Jw(a),a.H),(b=Nw(a))&&tw(b),Ow(a)&&!c&&A("yt.player.Application.create",null))}}}
function Iw(a){var b=kf(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function Kw(a){if(!a.i()){var b=Iw(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Mw(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Pw(a)}else a.Ja=dl(function(){Kw(a)},50)}}
function Pw(a){Aw(a);a.ea=!0;var b=Iw(a);if(b){a.s=Qw(a,b,"addEventListener");a.X=Qw(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Qw(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.s&&a.s(g,a.j[g]);Ew(a);a.Y&&a.Y(a.api);a.L.ta("onReady",a.api)}
function Qw(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Hr(f))}}}
function Aw(a){a.ea=!1;if(a.X)for(var b in a.j)a.j.hasOwnProperty(b)&&a.X(b,a.j[b]);for(var c in a.K)a.K.hasOwnProperty(c)&&window.clearTimeout(Number(c));a.K={};a.s=null;a.X=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Bw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){kq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){kq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=Gw(this,b);d&&(0<=eb(this.Wa,a)||this.j[a]||(b=Rw(this,a),this.s&&this.s(a,b)),this.L.subscribe(a,d),"onReady"===a&&this.isReady()&&dl(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=Gw(this,b))&&ti(this.L,a,b)};
function Gw(a,b){var c=b;if("string"===typeof b){if(a.la[b])return a.la[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(z,d)}catch(f){Gr(f)}};
a.la[b]=c}return c?c:null}
function Rw(a,b){var c="ytPlayer"+b+a.u;a.j[b]=c;z[c]=function(d){var e=dl(function(){if(!a.i()){try{a.L.ta(b,null!=d?d:void 0)}catch(h){Hr(new P("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.u,data:d}))}var f=a.K,g=String(e);g in f&&delete f[g]}},0);
sb(a.K,String(e))};
return c}
l.getPlayerType=function(){return this.R||(Iw(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function Lw(a){a.cancel();Aw(a);a.R=null;a.config&&(a.config.loaded=!1);var b=Iw(a);b&&(Hw(a)||!Ow(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.H&&xv(Jw(this),this.H);window.clearTimeout(this.Ja);this.P=!1};
l.D=function(){Lw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Gr(b)}this.la=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(z[this.j[a]]=null);this.va=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
function Ow(a){var b,c;a=null==(b=a.config)?void 0:null==(c=b.args)?void 0:c.fflags;return!!a&&-1!==a.indexOf("player_destroy_old_version=true")}
function Jw(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.jsUrl:(a=a.config.assets)?a.js:""}
function Nw(a){return a.webPlayerContextConfig?a.webPlayerContextConfig.cssUrl:(a=a.config.assets)?a.css:""}
function Mw(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===Rk(c||"","&")[b]}
function Fw(a){for(var b={},c=p(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?vb(e):e}return b}
;var Sw={},Tw="player_uid_"+(1E9*Math.random()>>>0);function Uw(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?kf(c):c;var e=Tw+"_"+Ra(c),f=Sw[e];if(f&&d)return Vw(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new zw(c,e,a,b);Sw[e]=f;kq("player-added",f.api);te(f,function(){delete Sw[f.getId()]});
return f.api}
function Vw(a,b){return b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags?a.args.fflags.includes("web_player_remove_playerproxy=true"):!1}
;var Ww=null,Xw=null,Yw=null;function Zw(){$w()}
function ax(){$w()}
function $w(){var a=Ww.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
function bx(){Ww&&Ww.sendAbandonmentPing&&Ww.sendAbandonmentPing();L("PL_ATT")&&(M("use_player_abuse_bg_library")?Iv.dispose():Jv.dispose());for(var a=Xh,b=0,c=yv.length;b<c;b++)a.ga(yv[b]);yv.length=0;wv("//static.doubleclick.net/instream/ad_status.js");zv=!1;Bk("DCLKSTAT",0);re(Yw,Xw);Ww&&(Ww.removeEventListener("onVideoDataChange",Zw),Ww.destroy())}
;function cx(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;os()&&tl(a,b,c)}
;function dx(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=L("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=L("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=oc(window.location.href);g&&f.push(g);g=oc(d);if(0<=eb(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),fc(f,d),d=f.href),d&&(d=pc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:Zr()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
cx(d,b,h)}else cx(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Ph:r;a:{r=void 0===r?Ph:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Nh&&m.isValid(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var w=Qb(r);else{b:if(Fh){try{w=new URL(r)}catch(t){w="https:";break b}w=w.protocol}else c:{w=document.createElement("a");try{w.href=r}catch(t){w=void 0;
break c}w=w.protocol;w=":"===w||""===w?"https:":w}w="javascript:"!==w?r:void 0}void 0!==w&&(c.href=w)}return!0}
;A("yt.setConfig",Bk);A("yt.config.set",Bk);A("yt.setMsg",ds);A("yt.msgs.set",ds);A("yt.logging.errors.log",Gr);
A("writeEmbed",function(){var a=L("PLAYER_CONFIG");if(!a){var b=L("PLAYER_VARS");b&&(a={args:b})}ys(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=L("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);$t();c=L("WEB_PLAYER_CONTEXT_CONFIGS").WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=Wk(window.location.href);
d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Ww=Uw(a,c);Ww.addEventListener("onVideoDataChange",Zw);Ww.addEventListener("onReady",ax);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?Yw=new jw(Ww):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Xw=new qw(window.parent,a,b),Yw=new nw(Ww,Xw.connection));Av();M("ytidb_create_logger_embed_killswitch")||M("embeds_web_disable_nwl")||$l();a={};Vv||(Vv=new Uv);Vv.install((a.flush_logs={callback:function(){Lq()}},
a));
M("embeds_web_disable_nwl")||Lp();M("ytidb_clear_embedded_player")&&Xh.V(function(){var e;if(!Iu){var f=Ts(),g={Gb:Hu,yc:Gu};f.providers.set(g.Gb,g);g={Vb:{feedbackEndpoint:Us(Cu),modifyChannelNotificationPreferenceEndpoint:Us(Du),playlistEditEndpoint:Us(Eu),subscribeEndpoint:Us(Au),unsubscribeEndpoint:Us(Bu),webPlayerShareEntityServiceEndpoint:Us(Fu)}};var h=Hs.getInstance(),k={};h&&(k.client_location=h);if(void 0===m){zs.i||(zs.i=new zs);var m=zs.i}void 0===e&&(e=f.resolve(Hu));nu(g,e,m,k);m={Gb:tu,
zc:mu.i};f.providers.set(m.Gb,m);Iu=f.resolve(tu)}kv()})});
var ex=Jk(function(){gu();var a=xl.getInstance(),b=Al(119),c=1<window.devicePixelRatio;if(document.body&&gi(document.body,"exp-invert-logo"))if(c&&!gi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!gi(d,"inverted-hdpi")){var e=ei(d);fi(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&gi(document.body,"inverted-hdpi")&&hi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Bl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete wl[b]:(c=d.toString(16),
wl[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in wl)d.push(f+"="+encodeURIComponent(String(wl[f])));tl(b,d.join("&"),63072E3,a.j,c)}Uu.i||(Uu.i=new Uu);a=Uu.i;f=16623;var g=void 0===g?{}:g;Object.values(es).includes(f)||(Hr(new P("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.s=[];a.N=[];g.Yb?Xu(a,f,g):Yu(a,f,g)}),fx=Jk(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?
bx():a.persisted||bx()}),gx=Jk(bx);
window.addEventListener?(window.addEventListener("load",ex),window.addEventListener("pagehide",fx)):window.attachEvent&&(window.attachEvent("onload",ex),window.attachEvent("onunload",gx));A("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Kv);A("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Lv);A("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Bv);A("yt.player.exports.navigate",B("yt.player.exports.navigate")||dx);
A("yt.util.activity.init",B("yt.util.activity.init")||$p);A("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||cq);A("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||aq);}).call(this);
